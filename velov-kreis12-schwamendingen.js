  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'schwamendingen'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'schwamendingen'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'schwamendingen'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'schwamendingen'}, ctx));
      }
...
/* ===== VELOV — Kreis 12 Schwamendingen =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-schwamendingen lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_SCHWAMENDINGEN_BY_LANG = {
  "DE": {
    "id": "schwamendingen_de",
    "h1": "Mobiler Velomechaniker Schwamendingen – Velo-Reparatur Kreis 12 (vor Ort)",
    "intro": "Plattfuss in Schwamendingen? VELOV ist deine mobile Velowerkstatt im Kreis 12 und kommt in der Regel innert 55 Minuten zu dir. Servicegebiet u.a.: Schwamendingerplatz, Bahnhof Stettbach, Hirzenbach, Saatlen, Auzelg, Tramendstation Schwamendingen.",
    "sections": [
      {
        "h2": "Schwamendingen – wir kennen das Quartier",
        "body": "Kreis 12 – Schwamendingen, der grüne Aussenkreis. Bahnhof Stettbach ist die Drehscheibe, von dort bedienen wir Hirzenbach, Saatlen, Auzelg. Genossenschafts-Siedlungen mit grossen Veloräumen sind ideal für unseren Service – wir empfehlen B2B-Aktionstage, die für mehrere Mieterinnen aufs Mal Plattfuss + Wartung kombinieren."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Schwamendingerplatz, am Bahnhof Stettbach und in Hirzenbach betreuen wir grosse Wohngenossenschaften mit B2B-Aktionstagen. Schwamendingerplatz · Bahnhof Stettbach · Hirzenbach · Saatlen · Auzelg · Tramendstation Schwamendingen · Glatttal · Zürichberg-Hang"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Schwamendingen?",
        "a": "Meist 40–60 Minuten ab WhatsApp-Buchung – Schwamendingen ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 12 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 12 (8051, 8052) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Schwamendingen sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Schwamendingen (Kreis 12) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/schwamendingen#business",
        "name": "VELOV — Mobile Velowerkstatt Schwamendingen",
        "url": "https://www.velov.ch/schwamendingen",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": "Schwamendingen",
            "item": "https://www.velov.ch/schwamendingen"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "schwamendingen_en",
    "h1": "Mobile Bike Mechanic Schwamendingen – Bicycle Repair Kreis 12 (on-site)",
    "intro": "Flat tyre in Schwamendingen? VELOV is your mobile bike workshop in Kreis 12, usually on-site within 55 minutes. Service area includes: Schwamendingerplatz, Bahnhof Stettbach, Hirzenbach, Saatlen, Auzelg, Tramendstation Schwamendingen.",
    "sections": [
      {
        "h2": "Schwamendingen – we know the area",
        "body": "Kreis 12 – Schwamendingen, the green outer district. Bahnhof Stettbach is the hub; from there we cover Hirzenbach, Saatlen, Auzelg. Co-op estates with large bike rooms are perfect for our service – we recommend B2B service days that bundle flat tyres + tune-ups for several tenants at once."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Near Schwamendingerplatz, Bahnhof Stettbach and Hirzenbach we serve large housing co-ops with B2B service days. Schwamendingerplatz · Bahnhof Stettbach · Hirzenbach · Saatlen · Auzelg · Tramendstation Schwamendingen · Glatttal · Zürichberg-Hang"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Schwamendingen?",
        "a": "Usually 40–60 minutes after WhatsApp booking – Schwamendingen is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 12?",
        "a": "We serve all addresses in Kreis 12 (8051, 8052) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Schwamendingen bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Schwamendingen (Kreis 12) · info@velov.ch"
  },
  "FR": {
    "id": "schwamendingen_fr",
    "h1": "Mécanicien vélo mobile Schwamendingen – Réparation vélo Kreis 12 (sur place)",
    "intro": "Crevaison à Schwamendingen ? VELOV est votre atelier vélo mobile dans le Kreis 12, généralement sur place en 55 minutes. Zone de service : Schwamendingerplatz, Bahnhof Stettbach, Hirzenbach, Saatlen, Auzelg, Tramendstation Schwamendingen.",
    "sections": [
      {
        "h2": "Schwamendingen – nous connaissons le quartier",
        "body": "Kreis 12 – Schwamendingen, quartier vert périphérique. Gare Stettbach, plaque tournante ; de là nous couvrons Hirzenbach, Saatlen, Auzelg. Coopératives avec grands locaux à vélos – idéal pour nos journées B2B groupant plusieurs locataires."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Près du Schwamendingerplatz, de la gare Stettbach et de Hirzenbach – grandes coopératives, journées B2B. Schwamendingerplatz · Bahnhof Stettbach · Hirzenbach · Saatlen · Auzelg · Tramendstation Schwamendingen · Glatttal · Zürichberg-Hang"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Schwamendingen ?",
        "a": "Habituellement 40–60 minutes après la réservation WhatsApp – Schwamendingen est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 12 ?",
        "a": "Toutes les adresses du Kreis 12 (8051, 8052), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Schwamendingen dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Schwamendingen (Kreis 12) · info@velov.ch"
  },
  "IT": {
    "id": "schwamendingen_it",
    "h1": "Meccanico bici mobile Schwamendingen – Riparazione bici Kreis 12 (sul posto)",
    "intro": "Foratura a Schwamendingen? VELOV è la tua officina mobile nel Kreis 12, di solito sul posto in 55 minuti. Zona di servizio: Schwamendingerplatz, Bahnhof Stettbach, Hirzenbach, Saatlen, Auzelg, Tramendstation Schwamendingen.",
    "sections": [
      {
        "h2": "Schwamendingen – conosciamo il quartiere",
        "body": "Kreis 12 – Schwamendingen, quartiere verde periferico. Stazione Stettbach, snodo principale; da lì copriamo Hirzenbach, Saatlen, Auzelg. Cooperative con grandi sale bici – ideali per le giornate B2B che raggruppano più inquilini."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Vicino allo Schwamendingerplatz, alla stazione Stettbach e a Hirzenbach – grandi cooperative, giornate B2B. Schwamendingerplatz · Bahnhof Stettbach · Hirzenbach · Saatlen · Auzelg · Tramendstation Schwamendingen · Glatttal · Zürichberg-Hang"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Schwamendingen?",
        "a": "Di solito 40–60 minuti dalla prenotazione WhatsApp – Schwamendingen è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 12?",
        "a": "Tutti gli indirizzi del Kreis 12 (8051, 8052), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Schwamendingen da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Schwamendingen (Kreis 12) · info@velov.ch"
  },
  "ES": {
    "id": "schwamendingen_es",
    "h1": "Mecánico de bici móvil Schwamendingen – Reparación de bicicleta Kreis 12 (in situ)",
    "intro": "¿Pinchazo en Schwamendingen? VELOV es tu taller móvil de bicis en el Kreis 12, normalmente en el lugar en 55 minutos. Zona de servicio: Schwamendingerplatz, Bahnhof Stettbach, Hirzenbach, Saatlen, Auzelg, Tramendstation Schwamendingen.",
    "sections": [
      {
        "h2": "Schwamendingen – conocemos el barrio",
        "body": "Kreis 12 – Schwamendingen, barrio verde periférico. Estación Stettbach, eje principal; desde allí cubrimos Hirzenbach, Saatlen, Auzelg. Cooperativas con grandes salas de bicis – ideal para jornadas B2B que agrupan varios inquilinos."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Cerca de Schwamendingerplatz, Bahnhof Stettbach y Hirzenbach – grandes cooperativas, jornadas B2B. Schwamendingerplatz · Bahnhof Stettbach · Hirzenbach · Saatlen · Auzelg · Tramendstation Schwamendingen · Glatttal · Zürichberg-Hang"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Schwamendingen?",
        "a": "Normalmente 40–60 minutos tras la reserva por WhatsApp – Schwamendingen está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 12?",
        "a": "Todas las direcciones del Kreis 12 (8051, 8052), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Schwamendingen desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Schwamendingen (Kreis 12) · info@velov.ch"
  }
};

const VELOV_SEO_SCHWAMENDINGEN_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Schwamendingen – Velo-Reparatur Kreis 12 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Schwamendingen, Kreis 12 (8051, 8052). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 12 · Ø 55 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Schwamendingen",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Schwamendingen buchen →",
    "sectionServices": "Services in Schwamendingen",
    "sectionWhy": "Warum VELOV in Schwamendingen?",
    "sectionCommon": "Häufige Probleme in Schwamendingen — VELOV Lösung",
    "sectionStory": "Schwamendingen – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Schwamendingen?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Schwamendingen)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Schwamendingen und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Schwamendingen. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Schwamendingen in 30 Min.",
    ...
    "story": "Kreis 12 – Schwamendingen, der grüne Aussenkreis. Bahnhof Stettbach ist die Drehscheibe, von dort bedienen wir Hirzenbach, Saatlen, Auzelg. Genossenschafts-Siedlungen mit grossen Veloräumen sind ideal für unseren Service – wir empfehlen B2B-Aktionstage, die für mehrere Mieterinnen aufs Mal Plattfuss + Wartung kombinieren.",
    "storyShort": "In der Nähe vom Schwamendingerplatz, am Bahnhof Stettbach und in Hirzenbach betreuen wir grosse Wohngenossenschaften mit B2B-Aktionstagen."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Schwamendingen – Bicycle Repair Kreis 12 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Schwamendingen, Kreis 12 (8051, 8052). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 12 · Ø 55 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Schwamendingen now →",
    "sectionServices": "Services in Schwamendingen",
    "sectionWhy": "Why VELOV in Schwamendingen?",
    "sectionCommon": "Common problems in Schwamendingen — VELOV solution",
    "sectionStory": "Schwamendingen – we know the area",
    "finalH2": "Bike broken in Schwamendingen?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Schwamendingen)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Schwamendingen and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Schwamendingen. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Schwamendingen within 30 min.",
    ...
    "story": "Kreis 12 – Schwamendingen, the green outer district. Bahnhof Stettbach is the hub; from there we cover Hirzenbach, Saatlen, Auzelg. Co-op estates with large bike rooms are perfect for our service – we recommend B2B service days that bundle flat tyres + tune-ups for several tenants at once.",
    "storyShort": "Near Schwamendingerplatz, Bahnhof Stettbach and Hirzenbach we serve large housing co-ops with B2B service days."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Schwamendingen – Réparation vélo Kreis 12 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Schwamendingen, Kreis 12 (8051, 8052). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 12 · ~55 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Schwamendingen →",
    "sectionServices": "Services à Schwamendingen",
    "sectionWhy": "Pourquoi VELOV à Schwamendingen ?",
    "sectionCommon": "Problèmes fréquents à Schwamendingen — solution VELOV",
    "sectionStory": "Schwamendingen – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Schwamendingen ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Schwamendingen)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Schwamendingen et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Schwamendingen. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Schwamendingen en 30 min.",
    ...
    "story": "Kreis 12 – Schwamendingen, quartier vert périphérique. Gare Stettbach, plaque tournante ; de là nous couvrons Hirzenbach, Saatlen, Auzelg. Coopératives avec grands locaux à vélos – idéal pour nos journées B2B groupant plusieurs locataires.",
    "storyShort": "Près du Schwamendingerplatz, de la gare Stettbach et de Hirzenbach – grandes coopératives, journées B2B."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Schwamendingen – Riparazione bici Kreis 12 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Schwamendingen, Kreis 12 (8051, 8052). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 12 · ~55 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Schwamendingen →",
    "sectionServices": "Servizi a Schwamendingen",
    "sectionWhy": "Perché VELOV a Schwamendingen?",
    "sectionCommon": "Problemi frequenti a Schwamendingen — soluzione VELOV",
    "sectionStory": "Schwamendingen – conosciamo il quartiere",
    "finalH2": "Bici rotta a Schwamendingen?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Schwamendingen)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Schwamendingen e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Schwamendingen. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Schwamendingen in 30 min.",
    ...
    "story": "Kreis 12 – Schwamendingen, quartiere verde periferico. Stazione Stettbach, snodo principale; da lì copriamo Hirzenbach, Saatlen, Auzelg. Cooperative con grandi sale bici – ideali per le giornate B2B che raggruppano più inquilini.",
    "storyShort": "Vicino allo Schwamendingerplatz, alla stazione Stettbach e a Hirzenbach – grandi cooperative, giornate B2B."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Schwamendingen – Reparación de bicicleta Kreis 12 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Schwamendingen, Kreis 12 (8051, 8052). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 12 · ~55 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Schwamendingen →",
    "sectionServices": "Servicios en Schwamendingen",
    "sectionWhy": "¿Por qué VELOV en Schwamendingen?",
    "sectionCommon": "Problemas frecuentes en Schwamendingen — solución VELOV",
    "sectionStory": "Schwamendingen – conocemos el barrio",
    "finalH2": "¿Bici rota en Schwamendingen?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Schwamendingen)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Schwamendingen y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Schwamendingen. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Schwamendingen en 30 min.",
    ...
    "story": "Kreis 12 – Schwamendingen, barrio verde periférico. Estación Stettbach, eje principal; desde allí cubrimos Hirzenbach, Saatlen, Auzelg. Cooperativas con grandes salas de bicis – ideal para jornadas B2B que agrupan varios inquilinos.",
    "storyShort": "Cerca de Schwamendingerplatz, Bahnhof Stettbach y Hirzenbach – grandes cooperativas, jornadas B2B."
  }
};

const VELOV_SEO_SCHWAMENDINGEN_KREIS = {
  "id": "schwamendingen",
  "slug": "schwamendingen",
  "kreis": 12,
  "kreisLabel": "Kreis 12",
...
class VelovSchwamendingen extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      zone: 'Schwamendingen',
      kreisId: 'schwamendingen',
      kreisLabel: 'Kreis 12',
      phone: '+41762352126',
      phoneDisplay: '+41 076 235 21 26',
      whatsapp: '41762352126',
      email: 'velovzh@gmail.com',
      url: 'https://velov.ch/schwamendingen',
      baseEta: 55,
      neighbours: [{ slug: 'affoltern-oerlikon-seebach', name: 'Affoltern, Oerlikon & Seebach' }, { slug: 'hottingen-witikon', name: 'Hottingen, Hirslanden & Witikon' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_SCHWAMENDINGEN_BY_LANG[this.lang] || VELOV_SEO_SCHWAMENDINGEN_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-schwamendingen-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-schwamendingen { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-schwamendingen *, velov-schwamendingen *::before, velov-schwamendingen *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovSchwamendingen.CONFIG;
    const T = VELOV_SEO_SCHWAMENDINGEN_I18N[this.lang] || VELOV_SEO_SCHWAMENDINGEN_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_SCHWAMENDINGEN_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-schwamendingen')) {
  customElements.define('velov-schwamendingen', VelovSchwamendingen);
}
