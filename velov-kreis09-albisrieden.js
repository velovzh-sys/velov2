  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'albisrieden'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'albisrieden'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'albisrieden'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'albisrieden'}, ctx));
      }
...
/* ===== VELOV — Kreis 9 Albisrieden & Altstetten =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-albisrieden lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_ALBISRIEDEN_BY_LANG = {
  "DE": {
    "id": "albisrieden_de",
    "h1": "Mobiler Velomechaniker Albisrieden & Altstetten – Velo-Reparatur Kreis 9 (vor Ort)",
    "intro": "Plattfuss in Albisrieden & Altstetten? VELOV ist deine mobile Velowerkstatt im Kreis 9 und kommt in der Regel innert 50 Minuten zu dir. Servicegebiet u.a.: Bahnhof Altstetten, Letzigrund Stadion, Lindenplatz, Albisriederplatz, Letzipark, Freilager.",
    "sections": [
      {
        "h2": "Albisrieden & Altstetten – wir kennen das Quartier",
        "body": "Kreis 9 – Bahnhof Altstetten, Letzigrund, Lindenplatz, Freilager. Grosses Quartier mit Wohnsiedlungen, Industrie, Familien. Vor und nach FCZ-Heimspielen oft Plattfuss-Notfälle am Letzigrund. Wir bedienen Albisrieden und Altstetten täglich – die längere Anfahrt vom Stadtzentrum gleichen wir mit fixen Routen aus."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Bahnhof Altstetten, am Letzigrund und beim Lindenplatz machen wir B2B-Aktionstage für grössere Wohngenossenschaften und Firmen. Bahnhof Altstetten · Letzigrund Stadion · Lindenplatz · Albisriederplatz · Letzipark · Freilager · Heuried · Triemli"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Albisrieden & Altstetten?",
        "a": "Meist 35–55 Minuten ab WhatsApp-Buchung – Albisrieden & Altstetten ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 9 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 9 (8047, 8048, 8049) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Albisrieden & Altstetten sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Albisrieden & Altstetten (Kreis 9) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/albisrieden-altstetten#business",
        "name": "VELOV — Mobile Velowerkstatt Albisrieden & Altstetten",
        "url": "https://www.velov.ch/albisrieden-altstetten",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Albisrieden & Altstetten",
            "item": "https://www.velov.ch/albisrieden-altstetten"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "albisrieden_en",
    "h1": "Mobile Bike Mechanic Albisrieden & Altstetten – Bicycle Repair Kreis 9 (on-site)",
    "intro": "Flat tyre in Albisrieden & Altstetten? VELOV is your mobile bike workshop in Kreis 9, usually on-site within 50 minutes. Service area includes: Bahnhof Altstetten, Letzigrund Stadion, Lindenplatz, Albisriederplatz, Letzipark, Freilager.",
    "sections": [
      {
        "h2": "Albisrieden & Altstetten – we know the area",
        "body": "Kreis 9 – Bahnhof Altstetten, Letzigrund stadium, Lindenplatz, Freilager. Large district with housing estates, industry, families. Before and after FCZ home games often flat-tyre calls near Letzigrund. We serve Albisrieden and Altstetten daily – the longer drive from the centre is offset by fixed routes."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Near Bahnhof Altstetten, Letzigrund and Lindenplatz we run B2B service days for larger housing co-ops and companies. Bahnhof Altstetten · Letzigrund Stadion · Lindenplatz · Albisriederplatz · Letzipark · Freilager · Heuried · Triemli"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Albisrieden & Altstetten?",
        "a": "Usually 35–55 minutes after WhatsApp booking – Albisrieden & Altstetten is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 9?",
        "a": "We serve all addresses in Kreis 9 (8047, 8048, 8049) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Albisrieden & Altstetten bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Albisrieden & Altstetten (Kreis 9) · info@velov.ch"
  },
  "FR": {
    "id": "albisrieden_fr",
    "h1": "Mécanicien vélo mobile Albisrieden & Altstetten – Réparation vélo Kreis 9 (sur place)",
    "intro": "Crevaison à Albisrieden & Altstetten ? VELOV est votre atelier vélo mobile dans le Kreis 9, généralement sur place en 50 minutes. Zone de service : Bahnhof Altstetten, Letzigrund Stadion, Lindenplatz, Albisriederplatz, Letzipark, Freilager.",
    "sections": [
      {
        "h2": "Albisrieden & Altstetten – nous connaissons le quartier",
        "body": "Kreis 9 – gare Altstetten, stade Letzigrund, Lindenplatz, Freilager. Grand quartier avec ensembles d'habitation, industrie, familles. Avant et après les matchs du FCZ, crevaisons fréquentes près du Letzigrund. Albisrieden et Altstetten desservis quotidiennement."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Près de la gare Altstetten, du Letzigrund et du Lindenplatz – journées B2B pour grandes coopératives et entreprises. Bahnhof Altstetten · Letzigrund Stadion · Lindenplatz · Albisriederplatz · Letzipark · Freilager · Heuried · Triemli"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Albisrieden & Altstetten ?",
        "a": "Habituellement 35–55 minutes après la réservation WhatsApp – Albisrieden & Altstetten est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 9 ?",
        "a": "Toutes les adresses du Kreis 9 (8047, 8048, 8049), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Albisrieden & Altstetten dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Albisrieden & Altstetten (Kreis 9) · info@velov.ch"
  },
  "IT": {
    "id": "albisrieden_it",
    "h1": "Meccanico bici mobile Albisrieden & Altstetten – Riparazione bici Kreis 9 (sul posto)",
    "intro": "Foratura a Albisrieden & Altstetten? VELOV è la tua officina mobile nel Kreis 9, di solito sul posto in 50 minuti. Zona di servizio: Bahnhof Altstetten, Letzigrund Stadion, Lindenplatz, Albisriederplatz, Letzipark, Freilager.",
    "sections": [
      {
        "h2": "Albisrieden & Altstetten – conosciamo il quartiere",
        "body": "Kreis 9 – stazione Altstetten, stadio Letzigrund, Lindenplatz, Freilager. Grande quartiere con complessi abitativi, industria, famiglie. Prima e dopo le partite dell'FCZ spesso forature al Letzigrund. Albisrieden e Altstetten serviti quotidianamente."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Vicino alla stazione Altstetten, Letzigrund e Lindenplatz – giornate B2B per grandi cooperative e aziende. Bahnhof Altstetten · Letzigrund Stadion · Lindenplatz · Albisriederplatz · Letzipark · Freilager · Heuried · Triemli"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Albisrieden & Altstetten?",
        "a": "Di solito 35–55 minuti dalla prenotazione WhatsApp – Albisrieden & Altstetten è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 9?",
        "a": "Tutti gli indirizzi del Kreis 9 (8047, 8048, 8049), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Albisrieden & Altstetten da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Albisrieden & Altstetten (Kreis 9) · info@velov.ch"
  },
  "ES": {
    "id": "albisrieden_es",
    "h1": "Mecánico de bici móvil Albisrieden & Altstetten – Reparación de bicicleta Kreis 9 (in situ)",
    "intro": "¿Pinchazo en Albisrieden & Altstetten? VELOV es tu taller móvil de bicis en el Kreis 9, normalmente en el lugar en 50 minutos. Zona de servicio: Bahnhof Altstetten, Letzigrund Stadion, Lindenplatz, Albisriederplatz, Letzipark, Freilager.",
    "sections": [
      {
        "h2": "Albisrieden & Altstetten – conocemos el barrio",
        "body": "Kreis 9 – Bahnhof Altstetten, estadio Letzigrund, Lindenplatz, Freilager. Gran barrio con bloques residenciales, industria, familias. Antes y después de partidos del FCZ, pinchazos frecuentes en Letzigrund. Albisrieden y Altstetten atendidos a diario."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Cerca de Bahnhof Altstetten, Letzigrund y Lindenplatz – jornadas B2B para grandes cooperativas y empresas. Bahnhof Altstetten · Letzigrund Stadion · Lindenplatz · Albisriederplatz · Letzipark · Freilager · Heuried · Triemli"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Albisrieden & Altstetten?",
        "a": "Normalmente 35–55 minutos tras la reserva por WhatsApp – Albisrieden & Altstetten está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 9?",
        "a": "Todas las direcciones del Kreis 9 (8047, 8048, 8049), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Albisrieden & Altstetten desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Albisrieden & Altstetten (Kreis 9) · info@velov.ch"
  }
};

const VELOV_SEO_ALBISRIEDEN_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Albisrieden & Altstetten – Velo-Reparatur Kreis 9 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Albisrieden & Altstetten, Kreis 9 (8047, 8048, 8049). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 9 · Ø 50 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Albisrieden & Altstetten",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Albisrieden & Altstetten buchen →",
    "sectionServices": "Services in Albisrieden & Altstetten",
    "sectionWhy": "Warum VELOV in Albisrieden & Altstetten?",
    "sectionCommon": "Häufige Probleme in Albisrieden & Altstetten — VELOV Lösung",
    "sectionStory": "Albisrieden & Altstetten – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Albisrieden & Altstetten?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Albisrieden & Altstetten)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Albisrieden & Altstetten und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Albisrieden & Altstetten. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Albisrieden & Altstetten in 30 Min.",
    ...
    "story": "Kreis 9 – Bahnhof Altstetten, Letzigrund, Lindenplatz, Freilager. Grosses Quartier mit Wohnsiedlungen, Industrie, Familien. Vor und nach FCZ-Heimspielen oft Plattfuss-Notfälle am Letzigrund. Wir bedienen Albisrieden und Altstetten täglich – die längere Anfahrt vom Stadtzentrum gleichen wir mit fixen Routen aus.",
    "storyShort": "In der Nähe vom Bahnhof Altstetten, am Letzigrund und beim Lindenplatz machen wir B2B-Aktionstage für grössere Wohngenossenschaften und Firmen."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Albisrieden & Altstetten – Bicycle Repair Kreis 9 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Albisrieden & Altstetten, Kreis 9 (8047, 8048, 8049). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 9 · Ø 50 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Albisrieden & Altstetten now →",
    "sectionServices": "Services in Albisrieden & Altstetten",
    "sectionWhy": "Why VELOV in Albisrieden & Altstetten?",
    "sectionCommon": "Common problems in Albisrieden & Altstetten — VELOV solution",
    "sectionStory": "Albisrieden & Altstetten – we know the area",
    "finalH2": "Bike broken in Albisrieden & Altstetten?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Albisrieden & Altstetten)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Albisrieden & Altstetten and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Albisrieden & Altstetten. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Albisrieden & Altstetten within 30 min.",
    ...
    "story": "Kreis 9 – Bahnhof Altstetten, Letzigrund stadium, Lindenplatz, Freilager. Large district with housing estates, industry, families. Before and after FCZ home games often flat-tyre calls near Letzigrund. We serve Albisrieden and Altstetten daily – the longer drive from the centre is offset by fixed routes.",
    "storyShort": "Near Bahnhof Altstetten, Letzigrund and Lindenplatz we run B2B service days for larger housing co-ops and companies."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Albisrieden & Altstetten – Réparation vélo Kreis 9 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Albisrieden & Altstetten, Kreis 9 (8047, 8048, 8049). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 9 · ~50 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Albisrieden & Altstetten →",
    "sectionServices": "Services à Albisrieden & Altstetten",
    "sectionWhy": "Pourquoi VELOV à Albisrieden & Altstetten ?",
    "sectionCommon": "Problèmes fréquents à Albisrieden & Altstetten — solution VELOV",
    "sectionStory": "Albisrieden & Altstetten – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Albisrieden & Altstetten ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Albisrieden & Altstetten)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Albisrieden & Altstetten et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Albisrieden & Altstetten. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Albisrieden & Altstetten en 30 min.",
    ...
    "story": "Kreis 9 – gare Altstetten, stade Letzigrund, Lindenplatz, Freilager. Grand quartier avec ensembles d'habitation, industrie, familles. Avant et après les matchs du FCZ, crevaisons fréquentes près du Letzigrund. Albisrieden et Altstetten desservis quotidiennement.",
    "storyShort": "Près de la gare Altstetten, du Letzigrund et du Lindenplatz – journées B2B pour grandes coopératives et entreprises."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Albisrieden & Altstetten – Riparazione bici Kreis 9 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Albisrieden & Altstetten, Kreis 9 (8047, 8048, 8049). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 9 · ~50 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Albisrieden & Altstetten →",
    "sectionServices": "Servizi a Albisrieden & Altstetten",
    "sectionWhy": "Perché VELOV a Albisrieden & Altstetten?",
    "sectionCommon": "Problemi frequenti a Albisrieden & Altstetten — soluzione VELOV",
    "sectionStory": "Albisrieden & Altstetten – conosciamo il quartiere",
    "finalH2": "Bici rotta a Albisrieden & Altstetten?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Albisrieden & Altstetten)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Albisrieden & Altstetten e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Albisrieden & Altstetten. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Albisrieden & Altstetten in 30 min.",
    ...
    "story": "Kreis 9 – stazione Altstetten, stadio Letzigrund, Lindenplatz, Freilager. Grande quartiere con complessi abitativi, industria, famiglie. Prima e dopo le partite dell'FCZ spesso forature al Letzigrund. Albisrieden e Altstetten serviti quotidianamente.",
    "storyShort": "Vicino alla stazione Altstetten, Letzigrund e Lindenplatz – giornate B2B per grandi cooperative e aziende."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Albisrieden & Altstetten – Reparación de bicicleta Kreis 9 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Albisrieden & Altstetten, Kreis 9 (8047, 8048, 8049). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 9 · ~50 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Albisrieden & Altstetten →",
    "sectionServices": "Servicios en Albisrieden & Altstetten",
    "sectionWhy": "¿Por qué VELOV en Albisrieden & Altstetten?",
    "sectionCommon": "Problemas frecuentes en Albisrieden & Altstetten — solución VELOV",
    "sectionStory": "Albisrieden & Altstetten – conocemos el barrio",
    "finalH2": "¿Bici rota en Albisrieden & Altstetten?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Albisrieden & Altstetten)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Albisrieden & Altstetten y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Albisrieden & Altstetten. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Albisrieden & Altstetten en 30 min.",
    ...
    "story": "Kreis 9 – Bahnhof Altstetten, estadio Letzigrund, Lindenplatz, Freilager. Gran barrio con bloques residenciales, industria, familias. Antes y después de partidos del FCZ, pinchazos frecuentes en Letzigrund. Albisrieden y Altstetten atendidos a diario.",
    "storyShort": "Cerca de Bahnhof Altstetten, Letzigrund y Lindenplatz – jornadas B2B para grandes cooperativas y empresas."
  }
};

const VELOV_SEO_ALBISRIEDEN_KREIS = {
  "id": "albisrieden",
  "slug": "albisrieden-altstetten",
  "kreis": 9,
  "kreisLabel": "Kreis 9",
  "plz": [
    "8047",
...
class VelovAlbisrieden extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      ...
      url: 'https://velov.ch/albisrieden-altstetten',
      baseEta: 50,
      neighbours: [{ slug: 'wiedikon', name: 'Wiedikon' }, { slug: 'industriequartier', name: 'Industriequartier' }, { slug: 'wipkingen-hoengg', name: 'Wipkingen & Höngg' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_ALBISRIEDEN_BY_LANG[this.lang] || VELOV_SEO_ALBISRIEDEN_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-albisrieden-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-albisrieden { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-albisrieden *, velov-albisrieden *::before, velov-albisrieden *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovAlbisrieden.CONFIG;
    const T = VELOV_SEO_ALBISRIEDEN_I18N[this.lang] || VELOV_SEO_ALBISRIEDEN_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_ALBISRIEDEN_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-albisrieden')) {
  customElements.define('velov-albisrieden', VelovAlbisrieden);
}
