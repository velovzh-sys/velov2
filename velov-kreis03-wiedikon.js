  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'wiedikon'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'wiedikon'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'wiedikon'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'wiedikon'}, ctx));
      }
...
/* ===== VELOV — Kreis 3 Wiedikon =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-wiedikon lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_WIEDIKON_BY_LANG = {
  "DE": {
    "id": "wiedikon_de",
    "h1": "Mobiler Velomechaniker Wiedikon – Velo-Reparatur Kreis 3 (vor Ort)",
    "intro": "Plattfuss in Wiedikon? VELOV ist deine mobile Velowerkstatt im Kreis 3 und kommt in der Regel innert 40 Minuten zu dir. Servicegebiet u.a.: Goldbrunnenplatz, Idaplatz, Bahnhof Wiedikon, Bahnhof Giesshübel, Kalkbreite, Bullingerplatz.",
    "sections": [
      {
        "h2": "Wiedikon – wir kennen das Quartier",
        "body": "Wiedikon ist eines unserer Stamm-Quartiere – Idaplatz, Goldbrunnenplatz, Kalkbreite. Genossenschafts-Häuser, viele Velo-Pendler, Familien mit Kindervelos. Wir sind hier mehrmals täglich unterwegs und reagieren oft in unter 40 Minuten. Friesenberg und Heuried den Hang hoch sind für unser Cargo-Bike kein Problem."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Idaplatz, an der Schmiede Wiedikon und in der Genossenschaft Kalkbreite sind wir Stamm-Mechaniker – auch für Firmen entlang der Birmensdorferstrasse. Goldbrunnenplatz · Idaplatz · Bahnhof Wiedikon · Bahnhof Giesshübel · Kalkbreite · Bullingerplatz · Albisriederplatz · Schmiede Wiedikon"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Wiedikon?",
        "a": "Meist 25–45 Minuten ab WhatsApp-Buchung – Wiedikon ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 3 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 3 (8003, 8004, 8045) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Wiedikon sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Wiedikon (Kreis 3) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/wiedikon#business",
        "name": "VELOV — Mobile Velowerkstatt Wiedikon",
        "url": "https://www.velov.ch/wiedikon",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": "Wiedikon",
            "item": "https://www.velov.ch/wiedikon"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "wiedikon_en",
    "h1": "Mobile Bike Mechanic Wiedikon – Bicycle Repair Kreis 3 (on-site)",
    "intro": "Flat tyre in Wiedikon? VELOV is your mobile bike workshop in Kreis 3, usually on-site within 40 minutes. Service area includes: Goldbrunnenplatz, Idaplatz, Bahnhof Wiedikon, Bahnhof Giesshübel, Kalkbreite, Bullingerplatz.",
    "sections": [
      {
        "h2": "Wiedikon – we know the area",
        "body": "Wiedikon is one of our home turfs – Idaplatz, Goldbrunnenplatz, Kalkbreite. Co-op housing, lots of bike commuters, families with kids' bikes. We are here multiple times a day and often react in under 40 minutes. Friesenberg and Heuried up the hill are no issue for our cargo bike."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Around Idaplatz, Schmiede Wiedikon and the Kalkbreite co-op we are regular mechanics – also for offices along Birmensdorferstrasse. Goldbrunnenplatz · Idaplatz · Bahnhof Wiedikon · Bahnhof Giesshübel · Kalkbreite · Bullingerplatz · Albisriederplatz · Schmiede Wiedikon"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Wiedikon?",
        "a": "Usually 25–45 minutes after WhatsApp booking – Wiedikon is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 3?",
        "a": "We serve all addresses in Kreis 3 (8003, 8004, 8045) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Wiedikon bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Wiedikon (Kreis 3) · info@velov.ch"
  },
  "FR": {
    "id": "wiedikon_fr",
    "h1": "Mécanicien vélo mobile Wiedikon – Réparation vélo Kreis 3 (sur place)",
    "intro": "Crevaison à Wiedikon ? VELOV est votre atelier vélo mobile dans le Kreis 3, généralement sur place en 40 minutes. Zone de service : Goldbrunnenplatz, Idaplatz, Bahnhof Wiedikon, Bahnhof Giesshübel, Kalkbreite, Bullingerplatz.",
    "sections": [
      {
        "h2": "Wiedikon – nous connaissons le quartier",
        "body": "Wiedikon est l'un de nos quartiers de prédilection – Idaplatz, Goldbrunnenplatz, Kalkbreite. Coopératives d'habitation, beaucoup de cyclistes pendulaires, familles avec vélos enfants. Nous y passons plusieurs fois par jour, souvent moins de 40 minutes. Friesenberg et Heuried en haut de la colline ne sont pas un problème pour notre cargo bike."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Autour de l'Idaplatz, Schmiede Wiedikon et la coopérative Kalkbreite – également pour les bureaux le long de la Birmensdorferstrasse. Goldbrunnenplatz · Idaplatz · Bahnhof Wiedikon · Bahnhof Giesshübel · Kalkbreite · Bullingerplatz · Albisriederplatz · Schmiede Wiedikon"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Wiedikon ?",
        "a": "Habituellement 25–45 minutes après la réservation WhatsApp – Wiedikon est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 3 ?",
        "a": "Toutes les adresses du Kreis 3 (8003, 8004, 8045), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Wiedikon dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Wiedikon (Kreis 3) · info@velov.ch"
  },
  "IT": {
    "id": "wiedikon_it",
    "h1": "Meccanico bici mobile Wiedikon – Riparazione bici Kreis 3 (sul posto)",
    "intro": "Foratura a Wiedikon? VELOV è la tua officina mobile nel Kreis 3, di solito sul posto in 40 minuti. Zona di servizio: Goldbrunnenplatz, Idaplatz, Bahnhof Wiedikon, Bahnhof Giesshübel, Kalkbreite, Bullingerplatz.",
    "sections": [
      {
        "h2": "Wiedikon – conosciamo il quartiere",
        "body": "Wiedikon è uno dei nostri quartieri abituali – Idaplatz, Goldbrunnenplatz, Kalkbreite. Cooperative abitative, molti pendolari in bici, famiglie con bici per bambini. Passiamo diverse volte al giorno, spesso sotto i 40 minuti. Friesenberg e Heuried in collina non sono un problema per la nostra cargo bike."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Intorno a Idaplatz, Schmiede Wiedikon e cooperativa Kalkbreite – anche per uffici lungo Birmensdorferstrasse. Goldbrunnenplatz · Idaplatz · Bahnhof Wiedikon · Bahnhof Giesshübel · Kalkbreite · Bullingerplatz · Albisriederplatz · Schmiede Wiedikon"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Wiedikon?",
        "a": "Di solito 25–45 minuti dalla prenotazione WhatsApp – Wiedikon è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 3?",
        "a": "Tutti gli indirizzi del Kreis 3 (8003, 8004, 8045), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Wiedikon da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Wiedikon (Kreis 3) · info@velov.ch"
  },
  "ES": {
    "id": "wiedikon_es",
    "h1": "Mecánico de bici móvil Wiedikon – Reparación de bicicleta Kreis 3 (in situ)",
    "intro": "¿Pinchazo en Wiedikon? VELOV es tu taller móvil de bicis en el Kreis 3, normalmente en el lugar en 40 minutos. Zona de servicio: Goldbrunnenplatz, Idaplatz, Bahnhof Wiedikon, Bahnhof Giesshübel, Kalkbreite, Bullingerplatz.",
    "sections": [
      {
        "h2": "Wiedikon – conocemos el barrio",
        "body": "Wiedikon es uno de nuestros barrios habituales – Idaplatz, Goldbrunnenplatz, Kalkbreite. Cooperativas de viviendas, muchos ciclistas urbanos, familias con bicis infantiles. Pasamos varias veces al día, a menudo en menos de 40 minutos. Friesenberg y Heuried colina arriba no son un problema para nuestra cargo bike."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Alrededor de Idaplatz, Schmiede Wiedikon y la cooperativa Kalkbreite – también para oficinas en Birmensdorferstrasse. Goldbrunnenplatz · Idaplatz · Bahnhof Wiedikon · Bahnhof Giesshübel · Kalkbreite · Bullingerplatz · Albisriederplatz · Schmiede Wiedikon"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Wiedikon?",
        "a": "Normalmente 25–45 minutos tras la reserva por WhatsApp – Wiedikon está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 3?",
        "a": "Todas las direcciones del Kreis 3 (8003, 8004, 8045), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Wiedikon desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Wiedikon (Kreis 3) · info@velov.ch"
  }
};

const VELOV_SEO_WIEDIKON_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Wiedikon – Velo-Reparatur Kreis 3 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Wiedikon, Kreis 3 (8003, 8004, 8045). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 3 · Ø 40 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Wiedikon buchen →",
    "sectionServices": "Services in Wiedikon",
    "sectionWhy": "Warum VELOV in Wiedikon?",
    "sectionCommon": "Häufige Probleme in Wiedikon — VELOV Lösung",
    "sectionStory": "Wiedikon – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Wiedikon?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Wiedikon)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Wiedikon und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Wiedikon. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Wiedikon in 30 Min.",
    ...
    "story": "Wiedikon ist eines unserer Stamm-Quartiere – Idaplatz, Goldbrunnenplatz, Kalkbreite. Genossenschafts-Häuser, viele Velo-Pendler, Familien mit Kindervelos. Wir sind hier mehrmals täglich unterwegs und reagieren oft in unter 40 Minuten. Friesenberg und Heuried den Hang hoch sind für unser Cargo-Bike kein Problem.",
    "storyShort": "In der Nähe vom Idaplatz, an der Schmiede Wiedikon und in der Genossenschaft Kalkbreite sind wir Stamm-Mechaniker – auch für Firmen entlang der Birmensdorferstrasse."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Wiedikon – Bicycle Repair Kreis 3 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Wiedikon, Kreis 3 (8003, 8004, 8045). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 3 · Ø 40 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Wiedikon now →",
    "sectionServices": "Services in Wiedikon",
    "sectionWhy": "Why VELOV in Wiedikon?",
    "sectionCommon": "Common problems in Wiedikon — VELOV solution",
    "sectionStory": "Wiedikon – we know the area",
    "finalH2": "Bike broken in Wiedikon?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Wiedikon)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Wiedikon and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Wiedikon. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Wiedikon within 30 min.",
    ...
    "story": "Wiedikon is one of our home turfs – Idaplatz, Goldbrunnenplatz, Kalkbreite. Co-op housing, lots of bike commuters, families with kids' bikes. We are here multiple times a day and often react in under 40 minutes. Friesenberg and Heuried up the hill are no issue for our cargo bike.",
    "storyShort": "Around Idaplatz, Schmiede Wiedikon and the Kalkbreite co-op we are regular mechanics – also for offices along Birmensdorferstrasse."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Wiedikon – Réparation vélo Kreis 3 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Wiedikon, Kreis 3 (8003, 8004, 8045). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 3 · ~40 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Wiedikon →",
    "sectionServices": "Services à Wiedikon",
    "sectionWhy": "Pourquoi VELOV à Wiedikon ?",
    "sectionCommon": "Problèmes fréquents à Wiedikon — solution VELOV",
    "sectionStory": "Wiedikon – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Wiedikon ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Wiedikon)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Wiedikon et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Wiedikon. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Wiedikon en 30 min.",
    ...
    "story": "Wiedikon est l'un de nos quartiers de prédilection – Idaplatz, Goldbrunnenplatz, Kalkbreite. Coopératives d'habitation, beaucoup de cyclistes pendulaires, familles avec vélos enfants. Nous y passons plusieurs fois par jour, souvent moins de 40 minutes. Friesenberg et Heuried en haut de la colline ne sont pas un problème pour notre cargo bike.",
    "storyShort": "Autour de l'Idaplatz, Schmiede Wiedikon et la coopérative Kalkbreite – également pour les bureaux le long de la Birmensdorferstrasse."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Wiedikon – Riparazione bici Kreis 3 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Wiedikon, Kreis 3 (8003, 8004, 8045). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 3 · ~40 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Wiedikon →",
    "sectionServices": "Servizi a Wiedikon",
    "sectionWhy": "Perché VELOV a Wiedikon?",
    "sectionCommon": "Problemi frequenti a Wiedikon — soluzione VELOV",
    "sectionStory": "Wiedikon – conosciamo il quartiere",
    "finalH2": "Bici rotta a Wiedikon?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Wiedikon)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Wiedikon e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Wiedikon. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Wiedikon in 30 min.",
    ...
    "story": "Wiedikon è uno dei nostri quartieri abituali – Idaplatz, Goldbrunnenplatz, Kalkbreite. Cooperative abitative, molti pendolari in bici, famiglie con bici per bambini. Passiamo diverse volte al giorno, spesso sotto i 40 minuti. Friesenberg e Heuried in collina non sono un problema per la nostra cargo bike.",
    "storyShort": "Intorno a Idaplatz, Schmiede Wiedikon e cooperativa Kalkbreite – anche per uffici lungo Birmensdorferstrasse."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Wiedikon – Reparación de bicicleta Kreis 3 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Wiedikon, Kreis 3 (8003, 8004, 8045). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 3 · ~40 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Wiedikon →",
    "sectionServices": "Servicios en Wiedikon",
    "sectionWhy": "¿Por qué VELOV en Wiedikon?",
    "sectionCommon": "Problemas frecuentes en Wiedikon — solución VELOV",
    "sectionStory": "Wiedikon – conocemos el barrio",
    "finalH2": "¿Bici rota en Wiedikon?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Wiedikon)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Wiedikon y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Wiedikon. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Wiedikon en 30 min.",
    ...
    "story": "Wiedikon es uno de nuestros barrios habituales – Idaplatz, Goldbrunnenplatz, Kalkbreite. Cooperativas de viviendas, muchos ciclistas urbanos, familias con bicis infantiles. Pasamos varias veces al día, a menudo en menos de 40 minutos. Friesenberg y Heuried colina arriba no son un problema para nuestra cargo bike.",
    "storyShort": "Alrededor de Idaplatz, Schmiede Wiedikon y la cooperativa Kalkbreite – también para oficinas en Birmensdorferstrasse."
  }
};

const VELOV_SEO_WIEDIKON_KREIS = {
  "id": "wiedikon",
  "slug": "wiedikon",
  "kreis": 3,
  "kreisLabel": "Kreis 3",
...
class VelovWiedikon extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      ...
      url: 'https://velov.ch/wiedikon',
      baseEta: 40,
      neighbours: [{ slug: 'aussersihl', name: 'Aussersihl' }, { slug: 'enge', name: 'Enge & Wollishofen' }, { slug: 'albisrieden-altstetten', name: 'Albisrieden & Altstetten' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_WIEDIKON_BY_LANG[this.lang] || VELOV_SEO_WIEDIKON_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-wiedikon-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-wiedikon { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-wiedikon *, velov-wiedikon *::before, velov-wiedikon *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovWiedikon.CONFIG;
    const T = VELOV_SEO_WIEDIKON_I18N[this.lang] || VELOV_SEO_WIEDIKON_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_WIEDIKON_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-wiedikon')) {
  customElements.define('velov-wiedikon', VelovWiedikon);
}
