  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'enge'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'enge'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'enge'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'enge'}, ctx));
      }
...
/* ===== VELOV — Kreis 2 Enge & Wollishofen =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-enge lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_ENGE_BY_LANG = {
  "DE": {
    "id": "enge_de",
    "h1": "Mobiler Velomechaniker Enge & Wollishofen – Velo-Reparatur Kreis 2 (vor Ort)",
    "intro": "Plattfuss in Enge & Wollishofen? VELOV ist deine mobile Velowerkstatt im Kreis 2 und kommt in der Regel innert 45 Minuten zu dir. Servicegebiet u.a.: Bahnhof Enge, Bürkliplatz, Mythenquai, Strandbad Mythenquai, Belvoirpark, Rieterpark.",
    "sections": [
      {
        "h2": "Enge & Wollishofen – wir kennen das Quartier",
        "body": "Der Kreis 2 zieht sich vom Bürkliplatz dem Zürichsee entlang bis Wollishofen und Leimbach. Wir kennen die Velorouten am Mythenquai bestens – Sommer-Pannen am Strandbad, Pendler-Notfälle am Bahnhof Enge, Wartungen in Wollishofen. Im Sommer fahren wir oft mehrere Plattfuss-Einsätze pro Tag entlang dem See."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Museum Rietberg, am Bahnhof Enge und im Belvoirpark waren wir schon oft im Einsatz – auch grössere Banken und Firmen am Mythenquai gehören zu unserem Stammgebiet. Bahnhof Enge · Bürkliplatz · Mythenquai · Strandbad Mythenquai · Belvoirpark · Rieterpark · Museum Rietberg · Bahnhof Wollishofen"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Enge & Wollishofen?",
        "a": "Meist 30–50 Minuten ab WhatsApp-Buchung – Enge & Wollishofen ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 2 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 2 (8002, 8038, 8041) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Enge & Wollishofen sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Enge & Wollishofen (Kreis 2) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/enge#business",
        "name": "VELOV — Mobile Velowerkstatt Enge & Wollishofen",
        "url": "https://www.velov.ch/enge",
  ...
  "EN": {
    "id": "enge_en",
    "h1": "Mobile Bike Mechanic Enge & Wollishofen – Bicycle Repair Kreis 2 (on-site)",
    "intro": "Flat tyre in Enge & Wollishofen? VELOV is your mobile bike workshop in Kreis 2, usually on-site within 45 minutes. Service area includes: Bahnhof Enge, Bürkliplatz, Mythenquai, Strandbad Mythenquai, Belvoirpark, Rieterpark.",
    "sections": [
      {
        "h2": "Enge & Wollishofen – we know the area",
        "body": "Kreis 2 stretches from Bürkliplatz along Lake Zürich down to Wollishofen and Leimbach. We know the bike routes along Mythenquai inside out – summer breakdowns at Strandbad Mythenquai, commuter emergencies at Bahnhof Enge, services in Wollishofen. In summer we often handle several flat-tyre jobs a day along the lake."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Around Museum Rietberg, Bahnhof Enge and Belvoirpark we have been on call many times – the larger banks and offices along Mythenquai are also regular territory. Bahnhof Enge · Bürkliplatz · Mythenquai · Strandbad Mythenquai · Belvoirpark · Rieterpark · Museum Rietberg · Bahnhof Wollishofen"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Enge & Wollishofen?",
        "a": "Usually 30–50 minutes after WhatsApp booking – Enge & Wollishofen is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 2?",
        "a": "We serve all addresses in Kreis 2 (8002, 8038, 8041) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Enge & Wollishofen bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Enge & Wollishofen (Kreis 2) · info@velov.ch"
  },
  "FR": {
    "id": "enge_fr",
    "h1": "Mécanicien vélo mobile Enge & Wollishofen – Réparation vélo Kreis 2 (sur place)",
    "intro": "Crevaison à Enge & Wollishofen ? VELOV est votre atelier vélo mobile dans le Kreis 2, généralement sur place en 45 minutes. Zone de service : Bahnhof Enge, Bürkliplatz, Mythenquai, Strandbad Mythenquai, Belvoirpark, Rieterpark.",
    "sections": [
      {
        "h2": "Enge & Wollishofen – nous connaissons le quartier",
        "body": "Le Kreis 2 s'étend du Bürkliplatz le long du lac de Zurich jusqu'à Wollishofen et Leimbach. Nous connaissons parfaitement les pistes cyclables du Mythenquai – pannes estivales au Strandbad, urgences à la gare d'Enge, entretiens à Wollishofen. En été, plusieurs crevaisons par jour le long du lac."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Autour du Museum Rietberg, de la gare d'Enge et du Belvoirpark – les bureaux et banques le long du Mythenquai font partie de notre zone régulière. Bahnhof Enge · Bürkliplatz · Mythenquai · Strandbad Mythenquai · Belvoirpark · Rieterpark · Museum Rietberg · Bahnhof Wollishofen"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Enge & Wollishofen ?",
        "a": "Habituellement 30–50 minutes après la réservation WhatsApp – Enge & Wollishofen est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 2 ?",
        "a": "Toutes les adresses du Kreis 2 (8002, 8038, 8041), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Enge & Wollishofen dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Enge & Wollishofen (Kreis 2) · info@velov.ch"
  },
  "IT": {
    "id": "enge_it",
    "h1": "Meccanico bici mobile Enge & Wollishofen – Riparazione bici Kreis 2 (sul posto)",
    "intro": "Foratura a Enge & Wollishofen? VELOV è la tua officina mobile nel Kreis 2, di solito sul posto in 45 minuti. Zona di servizio: Bahnhof Enge, Bürkliplatz, Mythenquai, Strandbad Mythenquai, Belvoirpark, Rieterpark.",
    "sections": [
      {
        "h2": "Enge & Wollishofen – conosciamo il quartiere",
        "body": "Il Kreis 2 si estende da Bürkliplatz lungo il lago di Zurigo fino a Wollishofen e Leimbach. Conosciamo benissimo le piste ciclabili sul Mythenquai – guasti estivi allo Strandbad, emergenze alla stazione di Enge, manutenzioni a Wollishofen. In estate diverse forature al giorno lungo il lago."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Intorno al Museum Rietberg, alla stazione di Enge e al Belvoirpark – uffici e banche lungo il Mythenquai sono zona abituale. Bahnhof Enge · Bürkliplatz · Mythenquai · Strandbad Mythenquai · Belvoirpark · Rieterpark · Museum Rietberg · Bahnhof Wollishofen"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Enge & Wollishofen?",
        "a": "Di solito 30–50 minuti dalla prenotazione WhatsApp – Enge & Wollishofen è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 2?",
        "a": "Tutti gli indirizzi del Kreis 2 (8002, 8038, 8041), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Enge & Wollishofen da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Enge & Wollishofen (Kreis 2) · info@velov.ch"
  },
  "ES": {
    "id": "enge_es",
    "h1": "Mecánico de bici móvil Enge & Wollishofen – Reparación de bicicleta Kreis 2 (in situ)",
    "intro": "¿Pinchazo en Enge & Wollishofen? VELOV es tu taller móvil de bicis en el Kreis 2, normalmente en el lugar en 45 minutos. Zona de servicio: Bahnhof Enge, Bürkliplatz, Mythenquai, Strandbad Mythenquai, Belvoirpark, Rieterpark.",
    "sections": [
      {
        "h2": "Enge & Wollishofen – conocemos el barrio",
        "body": "El Kreis 2 se extiende desde Bürkliplatz a lo largo del lago de Zúrich hasta Wollishofen y Leimbach. Conocemos las rutas ciclistas del Mythenquai a la perfección – averías de verano en el Strandbad, urgencias en Bahnhof Enge, mantenimientos en Wollishofen. En verano varias intervenciones diarias a la orilla del lago."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Alrededor del Museum Rietberg, Bahnhof Enge y Belvoirpark – oficinas y bancos a lo largo del Mythenquai son zona habitual. Bahnhof Enge · Bürkliplatz · Mythenquai · Strandbad Mythenquai · Belvoirpark · Rieterpark · Museum Rietberg · Bahnhof Wollishofen"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Enge & Wollishofen?",
        "a": "Normalmente 30–50 minutos tras la reserva por WhatsApp – Enge & Wollishofen está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 2?",
        "a": "Todas las direcciones del Kreis 2 (8002, 8038, 8041), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Enge & Wollishofen desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Enge & Wollishofen (Kreis 2) · info@velov.ch"
  }
};

const VELOV_SEO_ENGE_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Enge & Wollishofen – Velo-Reparatur Kreis 2 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Enge & Wollishofen, Kreis 2 (8002, 8038, 8041). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 2 · Ø 45 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Enge & Wollishofen",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Enge & Wollishofen buchen →",
    "sectionServices": "Services in Enge & Wollishofen",
    "sectionWhy": "Warum VELOV in Enge & Wollishofen?",
    "sectionCommon": "Häufige Probleme in Enge & Wollishofen — VELOV Lösung",
    "sectionStory": "Enge & Wollishofen – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Enge & Wollishofen?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Enge & Wollishofen)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Enge & Wollishofen und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Enge & Wollishofen. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Enge & Wollishofen in 30 Min.",
    ...
    "story": "Der Kreis 2 zieht sich vom Bürkliplatz dem Zürichsee entlang bis Wollishofen und Leimbach. Wir kennen die Velorouten am Mythenquai bestens – Sommer-Pannen am Strandbad, Pendler-Notfälle am Bahnhof Enge, Wartungen in Wollishofen. Im Sommer fahren wir oft mehrere Plattfuss-Einsätze pro Tag entlang dem See.",
    "storyShort": "In der Nähe vom Museum Rietberg, am Bahnhof Enge und im Belvoirpark waren wir schon oft im Einsatz – auch grössere Banken und Firmen am Mythenquai gehören zu unserem Stammgebiet."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Enge & Wollishofen – Bicycle Repair Kreis 2 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Enge & Wollishofen, Kreis 2 (8002, 8038, 8041). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 2 · Ø 45 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Enge & Wollishofen now →",
    "sectionServices": "Services in Enge & Wollishofen",
    "sectionWhy": "Why VELOV in Enge & Wollishofen?",
    "sectionCommon": "Common problems in Enge & Wollishofen — VELOV solution",
    "sectionStory": "Enge & Wollishofen – we know the area",
    "finalH2": "Bike broken in Enge & Wollishofen?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Enge & Wollishofen)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Enge & Wollishofen and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Enge & Wollishofen. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Enge & Wollishofen within 30 min.",
    ...
    "story": "Kreis 2 stretches from Bürkliplatz along Lake Zürich down to Wollishofen and Leimbach. We know the bike routes along Mythenquai inside out – summer breakdowns at Strandbad Mythenquai, commuter emergencies at Bahnhof Enge, services in Wollishofen. In summer we often handle several flat-tyre jobs a day along the lake.",
    "storyShort": "Around Museum Rietberg, Bahnhof Enge and Belvoirpark we have been on call many times – the larger banks and offices along Mythenquai are also regular territory."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Enge & Wollishofen – Réparation vélo Kreis 2 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Enge & Wollishofen, Kreis 2 (8002, 8038, 8041). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 2 · ~45 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Enge & Wollishofen →",
    "sectionServices": "Services à Enge & Wollishofen",
    "sectionWhy": "Pourquoi VELOV à Enge & Wollishofen ?",
    "sectionCommon": "Problèmes fréquents à Enge & Wollishofen — solution VELOV",
    "sectionStory": "Enge & Wollishofen – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Enge & Wollishofen ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Enge & Wollishofen)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Enge & Wollishofen et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Enge & Wollishofen. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Enge & Wollishofen en 30 min.",
    ...
    "story": "Le Kreis 2 s'étend du Bürkliplatz le long du lac de Zurich jusqu'à Wollishofen et Leimbach. Nous connaissons parfaitement les pistes cyclables du Mythenquai – pannes estivales au Strandbad, urgences à la gare d'Enge, entretiens à Wollishofen. En été, plusieurs crevaisons par jour le long du lac.",
    "storyShort": "Autour du Museum Rietberg, de la gare d'Enge et du Belvoirpark – les bureaux et banques le long du Mythenquai font partie de notre zone régulière."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Enge & Wollishofen – Riparazione bici Kreis 2 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Enge & Wollishofen, Kreis 2 (8002, 8038, 8041). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 2 · ~45 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Enge & Wollishofen →",
    "sectionServices": "Servizi a Enge & Wollishofen",
    "sectionWhy": "Perché VELOV a Enge & Wollishofen?",
    "sectionCommon": "Problemi frequenti a Enge & Wollishofen — soluzione VELOV",
    "sectionStory": "Enge & Wollishofen – conosciamo il quartiere",
    "finalH2": "Bici rotta a Enge & Wollishofen?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Enge & Wollishofen)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Enge & Wollishofen e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Enge & Wollishofen. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Enge & Wollishofen in 30 min.",
    ...
    "story": "Il Kreis 2 si estende da Bürkliplatz lungo il lago di Zurigo fino a Wollishofen e Leimbach. Conosciamo benissimo le piste ciclabili sul Mythenquai – guasti estivi allo Strandbad, emergenze alla stazione di Enge, manutenzioni a Wollishofen. In estate diverse forature al giorno lungo il lago.",
    "storyShort": "Intorno al Museum Rietberg, alla stazione di Enge e al Belvoirpark – uffici e banche lungo il Mythenquai sono zona abituale."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Enge & Wollishofen – Reparación de bicicleta Kreis 2 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Enge & Wollishofen, Kreis 2 (8002, 8038, 8041). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 2 · ~45 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Enge & Wollishofen →",
    "sectionServices": "Servicios en Enge & Wollishofen",
    "sectionWhy": "¿Por qué VELOV en Enge & Wollishofen?",
    "sectionCommon": "Problemas frecuentes en Enge & Wollishofen — solución VELOV",
    "sectionStory": "Enge & Wollishofen – conocemos el barrio",
    "finalH2": "¿Bici rota en Enge & Wollishofen?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Enge & Wollishofen)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Enge & Wollishofen y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Enge & Wollishofen. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Enge & Wollishofen en 30 min.",
    ...
    "story": "El Kreis 2 se extiende desde Bürkliplatz a lo largo del lago de Zúrich hasta Wollishofen y Leimbach. Conocemos las rutas ciclistas del Mythenquai a la perfección – averías de verano en el Strandbad, urgencias en Bahnhof Enge, mantenimientos en Wollishofen. En verano varias intervenciones diarias a la orilla del lago.",
    "storyShort": "Alrededor del Museum Rietberg, Bahnhof Enge y Belvoirpark – oficinas y bancos a lo largo del Mythenquai son zona habitual."
  }
};

const VELOV_SEO_ENGE_KREIS = {
  "id": "enge",
  "slug": "enge",
  "kreis": 2,
  "kreisLabel": "Kreis 2",
...
class VelovEnge extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      ...
      url: 'https://velov.ch/enge',
      baseEta: 45,
      neighbours: [{ slug: 'altstadt', name: 'Altstadt' }, { slug: 'wiedikon', name: 'Wiedikon' }, { slug: 'seefeld-riesbach', name: 'Seefeld & Riesbach' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_ENGE_BY_LANG[this.lang] || VELOV_SEO_ENGE_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-enge-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-enge { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-enge *, velov-enge *::before, velov-enge *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovEnge.CONFIG;
    const T = VELOV_SEO_ENGE_I18N[this.lang] || VELOV_SEO_ENGE_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_ENGE_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-enge')) {
  customElements.define('velov-enge', VelovEnge);
}
