  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'industriequartier'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'industriequartier'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'industriequartier'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'industriequartier'}, ctx));
      }
...
/* ===== VELOV — Kreis 5 Industriequartier =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-industriequartier lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_INDUSTRIEQUARTIER_BY_LANG = {
  "DE": {
    "id": "industriequartier_de",
    "h1": "Mobiler Velomechaniker Industriequartier – Velo-Reparatur Kreis 5 (vor Ort)",
    "intro": "Plattfuss in Industriequartier? VELOV ist deine mobile Velowerkstatt im Kreis 5 und kommt in der Regel innert 35 Minuten zu dir. Servicegebiet u.a.: Prime Tower, Hardbrücke, Bahnhof Hardbrücke, Toni-Areal, Schiffbau, Frau Gerolds Garten.",
    "sections": [
      {
        "h2": "Industriequartier – wir kennen das Quartier",
        "body": "Der Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Hier arbeiten Tausende, viele kommen mit dem Velo. Pannendienst-Notfälle am Bahnhof Hardbrücke gehören fast täglich dazu. Wir sind oft am Limmatplatz, im Viadukt-Bereich und beim Frau Gerolds Garten unterwegs."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Prime Tower, am Toni-Areal und beim Schiffbau betreuen wir regelmässig Pendler-Velos und einzelne Firmen-Flotten – B2B-Aktionstage hier sind besonders gefragt. Prime Tower · Hardbrücke · Bahnhof Hardbrücke · Toni-Areal · Schiffbau · Frau Gerolds Garten · Viadukt · Josefstrasse"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Industriequartier?",
        "a": "Meist 20–40 Minuten ab WhatsApp-Buchung – Industriequartier ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 5 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 5 (8005) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Industriequartier sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Industriequartier (Kreis 5) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/industriequartier#business",
        "name": "VELOV — Mobile Velowerkstatt Industriequartier",
        "url": "https://www.velov.ch/industriequartier",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Industriequartier",
            "item": "https://www.velov.ch/industriequartier"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "industriequartier_en",
    "h1": "Mobile Bike Mechanic Industrial District – Bicycle Repair Kreis 5 (on-site)",
    "intro": "Flat tyre in Industrial District? VELOV is your mobile bike workshop in Kreis 5, usually on-site within 35 minutes. Service area includes: Prime Tower, Hardbrücke, Bahnhof Hardbrücke, Toni-Areal, Schiffbau, Frau Gerolds Garten.",
    "sections": [
      {
        "h2": "Industrial District – we know the area",
        "body": "Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Thousands work here and many commute by bike. Emergency calls at Bahnhof Hardbrücke are nearly a daily occurrence. We are often around Limmatplatz, the Viadukt and Frau Gerolds Garten."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Near Prime Tower, Toni-Areal and Schiffbau we regularly look after commuter bikes and selected company fleets – B2B service days here are in high demand. Prime Tower · Hardbrücke · Bahnhof Hardbrücke · Toni-Areal · Schiffbau · Frau Gerolds Garten · Viadukt · Josefstrasse"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Industrial District?",
        "a": "Usually 20–40 minutes after WhatsApp booking – Industrial District is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 5?",
        "a": "We serve all addresses in Kreis 5 (8005) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Industrial District bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Industrial District (Kreis 5) · info@velov.ch"
  },
  "FR": {
    "id": "industriequartier_fr",
    "h1": "Mécanicien vélo mobile Quartier industriel – Réparation vélo Kreis 5 (sur place)",
    "intro": "Crevaison à Quartier industriel ? VELOV est votre atelier vélo mobile dans le Kreis 5, généralement sur place en 35 minutes. Zone de service : Prime Tower, Hardbrücke, Bahnhof Hardbrücke, Toni-Areal, Schiffbau, Frau Gerolds Garten.",
    "sections": [
      {
        "h2": "Quartier industriel – nous connaissons le quartier",
        "body": "Le Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Des milliers y travaillent, beaucoup à vélo. Les urgences à la gare Hardbrücke sont presque quotidiennes. Nous sommes souvent autour du Limmatplatz, du Viadukt et du Frau Gerolds Garten."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Près du Prime Tower, du Toni-Areal et du Schiffbau – vélos pendulaires et flottes d'entreprise, journées B2B très demandées. Prime Tower · Hardbrücke · Bahnhof Hardbrücke · Toni-Areal · Schiffbau · Frau Gerolds Garten · Viadukt · Josefstrasse"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Quartier industriel ?",
        "a": "Habituellement 20–40 minutes après la réservation WhatsApp – Quartier industriel est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 5 ?",
        "a": "Toutes les adresses du Kreis 5 (8005), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Quartier industriel dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Quartier industriel (Kreis 5) · info@velov.ch"
  },
  "IT": {
    "id": "industriequartier_it",
    "h1": "Meccanico bici mobile Quartiere industriale – Riparazione bici Kreis 5 (sul posto)",
    "intro": "Foratura a Quartiere industriale? VELOV è la tua officina mobile nel Kreis 5, di solito sul posto in 35 minuti. Zona di servizio: Prime Tower, Hardbrücke, Bahnhof Hardbrücke, Toni-Areal, Schiffbau, Frau Gerolds Garten.",
    "sections": [
      {
        "h2": "Quartiere industriale – conosciamo il quartiere",
        "body": "Il Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Migliaia di lavoratori, molti in bici. Emergenze alla stazione Hardbrücke quasi quotidiane. Siamo spesso a Limmatplatz, al Viadukt e al Frau Gerolds Garten."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Vicino al Prime Tower, al Toni-Areal e al Schiffbau – bici pendolari e flotte aziendali, giornate B2B molto richieste. Prime Tower · Hardbrücke · Bahnhof Hardbrücke · Toni-Areal · Schiffbau · Frau Gerolds Garten · Viadukt · Josefstrasse"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Quartiere industriale?",
        "a": "Di solito 20–40 minuti dalla prenotazione WhatsApp – Quartiere industriale è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 5?",
        "a": "Tutti gli indirizzi del Kreis 5 (8005), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Quartiere industriale da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Quartiere industriale (Kreis 5) · info@velov.ch"
  },
  "ES": {
    "id": "industriequartier_es",
    "h1": "Mecánico de bici móvil Distrito industrial – Reparación de bicicleta Kreis 5 (in situ)",
    "intro": "¿Pinchazo en Distrito industrial? VELOV es tu taller móvil de bicis en el Kreis 5, normalmente en el lugar en 35 minutos. Zona de servicio: Prime Tower, Hardbrücke, Bahnhof Hardbrücke, Toni-Areal, Schiffbau, Frau Gerolds Garten.",
    "sections": [
      {
        "h2": "Distrito industrial – conocemos el barrio",
        "body": "El Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Miles trabajan aquí, muchos en bici. Urgencias en Bahnhof Hardbrücke casi a diario. Estamos a menudo en Limmatplatz, el Viadukt y Frau Gerolds Garten."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Cerca de Prime Tower, Toni-Areal y Schiffbau – bicis de pendulares y flotas de empresa, jornadas B2B muy demandadas. Prime Tower · Hardbrücke · Bahnhof Hardbrücke · Toni-Areal · Schiffbau · Frau Gerolds Garten · Viadukt · Josefstrasse"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Distrito industrial?",
        "a": "Normalmente 20–40 minutos tras la reserva por WhatsApp – Distrito industrial está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 5?",
        "a": "Todas las direcciones del Kreis 5 (8005), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Distrito industrial desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Distrito industrial (Kreis 5) · info@velov.ch"
  }
};

const VELOV_SEO_INDUSTRIEQUARTIER_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Industriequartier – Velo-Reparatur Kreis 5 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Industriequartier, Kreis 5 (8005). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 5 · Ø 35 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Industriequartier",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Industriequartier buchen →",
    "sectionServices": "Services in Industriequartier",
    "sectionWhy": "Warum VELOV in Industriequartier?",
    "sectionCommon": "Häufige Probleme in Industriequartier — VELOV Lösung",
    "sectionStory": "Industriequartier – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Industriequartier?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Industriequartier)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Industriequartier und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Industriequartier. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Industriequartier in 30 Min.",
    ...
    "story": "Der Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Hier arbeiten Tausende, viele kommen mit dem Velo. Pannendienst-Notfälle am Bahnhof Hardbrücke gehören fast täglich dazu. Wir sind oft am Limmatplatz, im Viadukt-Bereich und beim Frau Gerolds Garten unterwegs.",
    "storyShort": "In der Nähe vom Prime Tower, am Toni-Areal und beim Schiffbau betreuen wir regelmässig Pendler-Velos und einzelne Firmen-Flotten – B2B-Aktionstage hier sind besonders gefragt."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Industrial District – Bicycle Repair Kreis 5 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Industrial District, Kreis 5 (8005). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 5 · Ø 35 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "All Locations",
    "kreisName": "Industrial District",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Industrial District now →",
    "sectionServices": "Services in Industrial District",
    "sectionWhy": "Why VELOV in Industrial District?",
    "sectionCommon": "Common problems in Industrial District — VELOV solution",
    "sectionStory": "Industrial District – we know the area",
    "finalH2": "Bike broken in Industrial District?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Industrial District)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Industrial District and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Industrial District. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Industrial District within 30 min.",
    ...
    "story": "Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Thousands work here and many commute by bike. Emergency calls at Bahnhof Hardbrücke are nearly a daily occurrence. We are often around Limmatplatz, the Viadukt and Frau Gerolds Garten.",
    "storyShort": "Near Prime Tower, Toni-Areal and Schiffbau we regularly look after commuter bikes and selected company fleets – B2B service days here are in high demand."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Quartier industriel – Réparation vélo Kreis 5 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Quartier industriel, Kreis 5 (8005). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 5 · ~35 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    "crumbLocations": "Tous les sites",
    "kreisName": "Quartier industriel",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Quartier industriel →",
    "sectionServices": "Services à Quartier industriel",
    "sectionWhy": "Pourquoi VELOV à Quartier industriel ?",
    "sectionCommon": "Problèmes fréquents à Quartier industriel — solution VELOV",
    "sectionStory": "Quartier industriel – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Quartier industriel ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Quartier industriel)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Quartier industriel et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Quartier industriel. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Quartier industriel en 30 min.",
    ...
    "story": "Le Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Des milliers y travaillent, beaucoup à vélo. Les urgences à la gare Hardbrücke sont presque quotidiennes. Nous sommes souvent autour du Limmatplatz, du Viadukt et du Frau Gerolds Garten.",
    "storyShort": "Près du Prime Tower, du Toni-Areal et du Schiffbau – vélos pendulaires et flottes d'entreprise, journées B2B très demandées."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Quartiere industriale – Riparazione bici Kreis 5 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Quartiere industriale, Kreis 5 (8005). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 5 · ~35 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Tutte le sedi",
    "kreisName": "Quartiere industriale",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Quartiere industriale →",
    "sectionServices": "Servizi a Quartiere industriale",
    "sectionWhy": "Perché VELOV a Quartiere industriale?",
    "sectionCommon": "Problemi frequenti a Quartiere industriale — soluzione VELOV",
    "sectionStory": "Quartiere industriale – conosciamo il quartiere",
    "finalH2": "Bici rotta a Quartiere industriale?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Quartiere industriale)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Quartiere industriale e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Quartiere industriale. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Quartiere industriale in 30 min.",
    ...
    "story": "Il Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Migliaia di lavoratori, molti in bici. Emergenze alla stazione Hardbrücke quasi quotidiane. Siamo spesso a Limmatplatz, al Viadukt e al Frau Gerolds Garten.",
    "storyShort": "Vicino al Prime Tower, al Toni-Areal e al Schiffbau – bici pendolari e flotte aziendali, giornate B2B molto richieste."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Distrito industrial – Reparación de bicicleta Kreis 5 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Distrito industrial, Kreis 5 (8005). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 5 · ~35 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    "crumbLocations": "Todas las zonas",
    "kreisName": "Distrito industrial",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Distrito industrial →",
    "sectionServices": "Servicios en Distrito industrial",
    "sectionWhy": "¿Por qué VELOV en Distrito industrial?",
    "sectionCommon": "Problemas frecuentes en Distrito industrial — solución VELOV",
    "sectionStory": "Distrito industrial – conocemos el barrio",
    "finalH2": "¿Bici rota en Distrito industrial?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Distrito industrial)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Distrito industrial y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Distrito industrial. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Distrito industrial en 30 min.",
    ...
    "story": "El Kreis 5 – Prime Tower, Hardbrücke, Toni-Areal, Schiffbau. Miles trabajan aquí, muchos en bici. Urgencias en Bahnhof Hardbrücke casi a diario. Estamos a menudo en Limmatplatz, el Viadukt y Frau Gerolds Garten.",
    "storyShort": "Cerca de Prime Tower, Toni-Areal y Schiffbau – bicis de pendulares y flotas de empresa, jornadas B2B muy demandadas."
  }
};

const VELOV_SEO_INDUSTRIEQUARTIER_KREIS = {
  "id": "industriequartier",
  "slug": "industriequartier",
  "kreis": 5,
  "kreisLabel": "Kreis 5",
  "plz": [
    "8005"
...
class VelovIndustriequartier extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      zone: 'Industriequartier',
      kreisId: 'industriequartier',
      kreisLabel: 'Kreis 5',
      phone: '+41762352126',
      phoneDisplay: '+41 076 235 21 26',
      whatsapp: '41762352126',
      email: 'velovzh@gmail.com',
      url: 'https://velov.ch/industriequartier',
      baseEta: 35,
      neighbours: [{ slug: 'altstadt', name: 'Altstadt' }, { slug: 'aussersihl', name: 'Aussersihl' }, { slug: 'wipkingen-hoengg', name: 'Wipkingen & Höngg' }, { slug: 'unterstrass-oberstrass', name: 'Unterstrass & Oberstrass' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_INDUSTRIEQUARTIER_BY_LANG[this.lang] || VELOV_SEO_INDUSTRIEQUARTIER_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-industriequartier-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-industriequartier { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-industriequartier *, velov-industriequartier *::before, velov-industriequartier *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovIndustriequartier.CONFIG;
    const T = VELOV_SEO_INDUSTRIEQUARTIER_I18N[this.lang] || VELOV_SEO_INDUSTRIEQUARTIER_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_INDUSTRIEQUARTIER_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-industriequartier')) {
  customElements.define('velov-industriequartier', VelovIndustriequartier);
}
