  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'wipkingen'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'wipkingen'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'wipkingen'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'wipkingen'}, ctx));
      }
...
/* ===== VELOV — Kreis 10 Wipkingen & Höngg =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-wipkingen lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_WIPKINGEN_BY_LANG = {
  "DE": {
    "id": "wipkingen_de",
    "h1": "Mobiler Velomechaniker Wipkingen & Höngg – Velo-Reparatur Kreis 10 (vor Ort)",
    "intro": "Plattfuss in Wipkingen & Höngg? VELOV ist deine mobile Velowerkstatt im Kreis 10 und kommt in der Regel innert 50 Minuten zu dir. Servicegebiet u.a.: Bahnhof Wipkingen, Röschibachplatz, Bucheggplatz, Käferberg, Höngg Zentrum, Frankental.",
    "sections": [
      {
        "h2": "Wipkingen & Höngg – wir kennen das Quartier",
        "body": "Kreis 10 – Wipkingen und Höngg, der Limmat entlang. Werdinsel im Sommer, Limmatuferweg ganzjährig. Höngg liegt am Hang, also viele E-Bikes – Pendler aus Höngg ins Stadtzentrum sind unsere Stammkundschaft. Bahnhof Wipkingen ist ein klassischer Notfall-Treffpunkt, fünf Minuten von der Hardbrücke entfernt."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Röschibachplatz, am Bucheggplatz und im Höngg Zentrum betreuen wir vor allem E-Bike-Pendler und Familien. Bahnhof Wipkingen · Röschibachplatz · Bucheggplatz · Käferberg · Höngg Zentrum · Frankental · Werdinsel · Limmatuferweg"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Wipkingen & Höngg?",
        "a": "Meist 35–55 Minuten ab WhatsApp-Buchung – Wipkingen & Höngg ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 10 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 10 (8037, 8049) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Wipkingen & Höngg sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Wipkingen & Höngg (Kreis 10) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/wipkingen-hoengg#business",
        "name": "VELOV — Mobile Velowerkstatt Wipkingen & Höngg",
        "url": "https://www.velov.ch/wipkingen-hoengg",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Wipkingen & Höngg",
            "item": "https://www.velov.ch/wipkingen-hoengg"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "wipkingen_en",
    "h1": "Mobile Bike Mechanic Wipkingen & Höngg – Bicycle Repair Kreis 10 (on-site)",
    "intro": "Flat tyre in Wipkingen & Höngg? VELOV is your mobile bike workshop in Kreis 10, usually on-site within 50 minutes. Service area includes: Bahnhof Wipkingen, Röschibachplatz, Bucheggplatz, Käferberg, Höngg Zentrum, Frankental.",
    "sections": [
      {
        "h2": "Wipkingen & Höngg – we know the area",
        "body": "Kreis 10 – Wipkingen and Höngg, along the Limmat. Werdinsel in summer, the Limmat riverside path year-round. Höngg sits on the hillside, so lots of e-bikes – commuters from Höngg into the centre are our regulars. Bahnhof Wipkingen is a classic emergency rendez-vous, five minutes from Hardbrücke."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Around Röschibachplatz, Bucheggplatz and Höngg centre we look after mostly e-bike commuters and families. Bahnhof Wipkingen · Röschibachplatz · Bucheggplatz · Käferberg · Höngg Zentrum · Frankental · Werdinsel · Limmatuferweg"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Wipkingen & Höngg?",
        "a": "Usually 35–55 minutes after WhatsApp booking – Wipkingen & Höngg is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 10?",
        "a": "We serve all addresses in Kreis 10 (8037, 8049) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Wipkingen & Höngg bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Wipkingen & Höngg (Kreis 10) · info@velov.ch"
  },
  "FR": {
    "id": "wipkingen_fr",
    "h1": "Mécanicien vélo mobile Wipkingen & Höngg – Réparation vélo Kreis 10 (sur place)",
    "intro": "Crevaison à Wipkingen & Höngg ? VELOV est votre atelier vélo mobile dans le Kreis 10, généralement sur place en 50 minutes. Zone de service : Bahnhof Wipkingen, Röschibachplatz, Bucheggplatz, Käferberg, Höngg Zentrum, Frankental.",
    "sections": [
      {
        "h2": "Wipkingen & Höngg – nous connaissons le quartier",
        "body": "Kreis 10 – Wipkingen et Höngg, le long de la Limmat. Werdinsel en été, sentier riverain toute l'année. Höngg en pente, donc beaucoup de e-bikes – pendulaires Höngg-centre sont nos habitués. Gare Wipkingen, classique point d'urgence, cinq minutes de la Hardbrücke."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Autour du Röschibachplatz, du Bucheggplatz et du centre de Höngg – surtout pendulaires e-bike et familles. Bahnhof Wipkingen · Röschibachplatz · Bucheggplatz · Käferberg · Höngg Zentrum · Frankental · Werdinsel · Limmatuferweg"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Wipkingen & Höngg ?",
        "a": "Habituellement 35–55 minutes après la réservation WhatsApp – Wipkingen & Höngg est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 10 ?",
        "a": "Toutes les adresses du Kreis 10 (8037, 8049), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Wipkingen & Höngg dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Wipkingen & Höngg (Kreis 10) · info@velov.ch"
  },
  "IT": {
    "id": "wipkingen_it",
    "h1": "Meccanico bici mobile Wipkingen & Höngg – Riparazione bici Kreis 10 (sul posto)",
    "intro": "Foratura a Wipkingen & Höngg? VELOV è la tua officina mobile nel Kreis 10, di solito sul posto in 50 minuti. Zona di servizio: Bahnhof Wipkingen, Röschibachplatz, Bucheggplatz, Käferberg, Höngg Zentrum, Frankental.",
    "sections": [
      {
        "h2": "Wipkingen & Höngg – conosciamo il quartiere",
        "body": "Kreis 10 – Wipkingen e Höngg, lungo la Limmat. Werdinsel d'estate, lungofiume tutto l'anno. Höngg in pendenza, molte e-bike – pendolari Höngg-centro sono clienti abituali. Stazione Wipkingen, classico punto d'emergenza, cinque minuti dalla Hardbrücke."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Intorno a Röschibachplatz, Bucheggplatz e centro Höngg – soprattutto pendolari e-bike e famiglie. Bahnhof Wipkingen · Röschibachplatz · Bucheggplatz · Käferberg · Höngg Zentrum · Frankental · Werdinsel · Limmatuferweg"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Wipkingen & Höngg?",
        "a": "Di solito 35–55 minuti dalla prenotazione WhatsApp – Wipkingen & Höngg è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 10?",
        "a": "Tutti gli indirizzi del Kreis 10 (8037, 8049), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Wipkingen & Höngg da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Wipkingen & Höngg (Kreis 10) · info@velov.ch"
  },
  "ES": {
    "id": "wipkingen_es",
    "h1": "Mecánico de bici móvil Wipkingen & Höngg – Reparación de bicicleta Kreis 10 (in situ)",
    "intro": "¿Pinchazo en Wipkingen & Höngg? VELOV es tu taller móvil de bicis en el Kreis 10, normalmente en el lugar en 50 minutos. Zona de servicio: Bahnhof Wipkingen, Röschibachplatz, Bucheggplatz, Käferberg, Höngg Zentrum, Frankental.",
    "sections": [
      {
        "h2": "Wipkingen & Höngg – conocemos el barrio",
        "body": "Kreis 10 – Wipkingen y Höngg, a lo largo del Limmat. Werdinsel en verano, sendero ribereño todo el año. Höngg en pendiente, muchas e-bikes – pendulares Höngg-centro son habituales. Estación Wipkingen, punto clásico de urgencia, cinco minutos de Hardbrücke."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Alrededor de Röschibachplatz, Bucheggplatz y centro de Höngg – sobre todo pendulares de e-bike y familias. Bahnhof Wipkingen · Röschibachplatz · Bucheggplatz · Käferberg · Höngg Zentrum · Frankental · Werdinsel · Limmatuferweg"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Wipkingen & Höngg?",
        "a": "Normalmente 35–55 minutos tras la reserva por WhatsApp – Wipkingen & Höngg está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 10?",
        "a": "Todas las direcciones del Kreis 10 (8037, 8049), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Wipkingen & Höngg desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Wipkingen & Höngg (Kreis 10) · info@velov.ch"
  }
};

const VELOV_SEO_WIPKINGEN_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Wipkingen & Höngg – Velo-Reparatur Kreis 10 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Wipkingen & Höngg, Kreis 10 (8037, 8049). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 10 · Ø 50 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Wipkingen & Höngg",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Wipkingen & Höngg buchen →",
    "sectionServices": "Services in Wipkingen & Höngg",
    "sectionWhy": "Warum VELOV in Wipkingen & Höngg?",
    "sectionCommon": "Häufige Probleme in Wipkingen & Höngg — VELOV Lösung",
    "sectionStory": "Wipkingen & Höngg – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Wipkingen & Höngg?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Wipkingen & Höngg)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Wipkingen & Höngg und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Wipkingen & Höngg. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Wipkingen & Höngg in 30 Min.",
    ...
    "story": "Kreis 10 – Wipkingen und Höngg, der Limmat entlang. Werdinsel im Sommer, Limmatuferweg ganzjährig. Höngg liegt am Hang, also viele E-Bikes – Pendler aus Höngg ins Stadtzentrum sind unsere Stammkundschaft. Bahnhof Wipkingen ist ein klassischer Notfall-Treffpunkt, fünf Minuten von der Hardbrücke entfernt.",
    "storyShort": "In der Nähe vom Röschibachplatz, am Bucheggplatz und im Höngg Zentrum betreuen wir vor allem E-Bike-Pendler und Familien."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Wipkingen & Höngg – Bicycle Repair Kreis 10 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Wipkingen & Höngg, Kreis 10 (8037, 8049). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 10 · Ø 50 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Wipkingen & Höngg now →",
    "sectionServices": "Services in Wipkingen & Höngg",
    "sectionWhy": "Why VELOV in Wipkingen & Höngg?",
    "sectionCommon": "Common problems in Wipkingen & Höngg — VELOV solution",
    "sectionStory": "Wipkingen & Höngg – we know the area",
    "finalH2": "Bike broken in Wipkingen & Höngg?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Wipkingen & Höngg)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Wipkingen & Höngg and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Wipkingen & Höngg. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Wipkingen & Höngg within 30 min.",
    ...
    "story": "Kreis 10 – Wipkingen and Höngg, along the Limmat. Werdinsel in summer, the Limmat riverside path year-round. Höngg sits on the hillside, so lots of e-bikes – commuters from Höngg into the centre are our regulars. Bahnhof Wipkingen is a classic emergency rendez-vous, five minutes from Hardbrücke.",
    "storyShort": "Around Röschibachplatz, Bucheggplatz and Höngg centre we look after mostly e-bike commuters and families."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Wipkingen & Höngg – Réparation vélo Kreis 10 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Wipkingen & Höngg, Kreis 10 (8037, 8049). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 10 · ~50 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Wipkingen & Höngg →",
    "sectionServices": "Services à Wipkingen & Höngg",
    "sectionWhy": "Pourquoi VELOV à Wipkingen & Höngg ?",
    "sectionCommon": "Problèmes fréquents à Wipkingen & Höngg — solution VELOV",
    "sectionStory": "Wipkingen & Höngg – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Wipkingen & Höngg ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Wipkingen & Höngg)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Wipkingen & Höngg et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Wipkingen & Höngg. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Wipkingen & Höngg en 30 min.",
    ...
    "story": "Kreis 10 – Wipkingen et Höngg, le long de la Limmat. Werdinsel en été, sentier riverain toute l'année. Höngg en pente, donc beaucoup de e-bikes – pendulaires Höngg-centre sont nos habitués. Gare Wipkingen, classique point d'urgence, cinq minutes de la Hardbrücke.",
    "storyShort": "Autour du Röschibachplatz, du Bucheggplatz et du centre de Höngg – surtout pendulaires e-bike et familles."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Wipkingen & Höngg – Riparazione bici Kreis 10 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Wipkingen & Höngg, Kreis 10 (8037, 8049). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 10 · ~50 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Wipkingen & Höngg →",
    "sectionServices": "Servizi a Wipkingen & Höngg",
    "sectionWhy": "Perché VELOV a Wipkingen & Höngg?",
    "sectionCommon": "Problemi frequenti a Wipkingen & Höngg — soluzione VELOV",
    "sectionStory": "Wipkingen & Höngg – conosciamo il quartiere",
    "finalH2": "Bici rotta a Wipkingen & Höngg?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Wipkingen & Höngg)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Wipkingen & Höngg e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Wipkingen & Höngg. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Wipkingen & Höngg in 30 min.",
    ...
    "story": "Kreis 10 – Wipkingen e Höngg, lungo la Limmat. Werdinsel d'estate, lungofiume tutto l'anno. Höngg in pendenza, molte e-bike – pendolari Höngg-centro sono clienti abituali. Stazione Wipkingen, classico punto d'emergenza, cinque minuti dalla Hardbrücke.",
    "storyShort": "Intorno a Röschibachplatz, Bucheggplatz e centro Höngg – soprattutto pendolari e-bike e famiglie."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Wipkingen & Höngg – Reparación de bicicleta Kreis 10 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Wipkingen & Höngg, Kreis 10 (8037, 8049). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 10 · ~50 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Wipkingen & Höngg →",
    "sectionServices": "Servicios en Wipkingen & Höngg",
    "sectionWhy": "¿Por qué VELOV en Wipkingen & Höngg?",
    "sectionCommon": "Problemas frecuentes en Wipkingen & Höngg — solución VELOV",
    "sectionStory": "Wipkingen & Höngg – conocemos el barrio",
    "finalH2": "¿Bici rota en Wipkingen & Höngg?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Wipkingen & Höngg)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Wipkingen & Höngg y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Wipkingen & Höngg. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Wipkingen & Höngg en 30 min.",
    ...
    "story": "Kreis 10 – Wipkingen y Höngg, a lo largo del Limmat. Werdinsel en verano, sendero ribereño todo el año. Höngg en pendiente, muchas e-bikes – pendulares Höngg-centro son habituales. Estación Wipkingen, punto clásico de urgencia, cinco minutos de Hardbrücke.",
    "storyShort": "Alrededor de Röschibachplatz, Bucheggplatz y centro de Höngg – sobre todo pendulares de e-bike y familias."
  }
};

const VELOV_SEO_WIPKINGEN_KREIS = {
  "id": "wipkingen",
  "slug": "wipkingen-hoengg",
  "kreis": 10,
  "kreisLabel": "Kreis 10",
  "plz": [
    "8037",
...
class VelovWipkingen extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      ...
      url: 'https://velov.ch/wipkingen-hoengg',
      baseEta: 50,
      neighbours: [{ slug: 'industriequartier', name: 'Industriequartier' }, { slug: 'unterstrass-oberstrass', name: 'Unterstrass & Oberstrass' }, { slug: 'affoltern-oerlikon-seebach', name: 'Affoltern, Oerlikon & Seebach' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_WIPKINGEN_BY_LANG[this.lang] || VELOV_SEO_WIPKINGEN_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-wipkingen-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-wipkingen { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-wipkingen *, velov-wipkingen *::before, velov-wipkingen *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovWipkingen.CONFIG;
    const T = VELOV_SEO_WIPKINGEN_I18N[this.lang] || VELOV_SEO_WIPKINGEN_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_WIPKINGEN_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-wipkingen')) {
  customElements.define('velov-wipkingen', VelovWipkingen);
}
