  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'aussersihl'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'aussersihl'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'aussersihl'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'aussersihl'}, ctx));
      }
...
/* ===== VELOV — Kreis 4 Aussersihl =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-aussersihl lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_AUSSERSIHL_BY_LANG = {
  "DE": {
    "id": "aussersihl_de",
    "h1": "Mobiler Velomechaniker Aussersihl – Velo-Reparatur Kreis 4 (vor Ort)",
    "intro": "Plattfuss in Aussersihl? VELOV ist deine mobile Velowerkstatt im Kreis 4 und kommt in der Regel innert 35 Minuten zu dir. Servicegebiet u.a.: Helvetiaplatz, Lochergut, Stauffacher, Volkshaus, Langstrasse, Bäckeranlage.",
    "sections": [
      {
        "h2": "Aussersihl – wir kennen das Quartier",
        "body": "Aussersihl – die Langstrasse, Helvetiaplatz, Hardplatz. Dichtes urbanes Quartier mit viel Velo-Verkehr Tag und Nacht. Wir reparieren hier oft auch abends und am Wochenende. Lochergut und Bäckeranlage sind klassische Treffpunkte für unsere Vor-Ort-Reparaturen."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Helvetiaplatz, am Lochergut und an der Langstrasse haben wir schon unzählige Same-day-Reparaturen für Cafés, Bars und Anwohnerinnen gemacht. Helvetiaplatz · Lochergut · Stauffacher · Volkshaus · Langstrasse · Bäckeranlage · Kanzleiareal · Kasernenwiese"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Aussersihl?",
        "a": "Meist 20–40 Minuten ab WhatsApp-Buchung – Aussersihl ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 4 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 4 (8004) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Aussersihl sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Aussersihl (Kreis 4) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/aussersihl#business",
        "name": "VELOV — Mobile Velowerkstatt Aussersihl",
        "url": "https://www.velov.ch/aussersihl",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": "Aussersihl",
            "item": "https://www.velov.ch/aussersihl"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "aussersihl_en",
    "h1": "Mobile Bike Mechanic Aussersihl – Bicycle Repair Kreis 4 (on-site)",
    "intro": "Flat tyre in Aussersihl? VELOV is your mobile bike workshop in Kreis 4, usually on-site within 35 minutes. Service area includes: Helvetiaplatz, Lochergut, Stauffacher, Volkshaus, Langstrasse, Bäckeranlage.",
    "sections": [
      {
        "h2": "Aussersihl – we know the area",
        "body": "Aussersihl – Langstrasse, Helvetiaplatz, Hardplatz. Dense urban district with heavy bike traffic day and night. We frequently work here in the evenings and on weekends. Lochergut and Bäckeranlage are classic meeting points for our on-site repairs."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Around Helvetiaplatz, Lochergut and along Langstrasse we have done countless same-day repairs for cafés, bars and residents. Helvetiaplatz · Lochergut · Stauffacher · Volkshaus · Langstrasse · Bäckeranlage · Kanzleiareal · Kasernenwiese"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Aussersihl?",
        "a": "Usually 20–40 minutes after WhatsApp booking – Aussersihl is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 4?",
        "a": "We serve all addresses in Kreis 4 (8004) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Aussersihl bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Aussersihl (Kreis 4) · info@velov.ch"
  },
  "FR": {
    "id": "aussersihl_fr",
    "h1": "Mécanicien vélo mobile Aussersihl – Réparation vélo Kreis 4 (sur place)",
    "intro": "Crevaison à Aussersihl ? VELOV est votre atelier vélo mobile dans le Kreis 4, généralement sur place en 35 minutes. Zone de service : Helvetiaplatz, Lochergut, Stauffacher, Volkshaus, Langstrasse, Bäckeranlage.",
    "sections": [
      {
        "h2": "Aussersihl – nous connaissons le quartier",
        "body": "Aussersihl – la Langstrasse, Helvetiaplatz, Hardplatz. Quartier urbain dense avec une forte circulation cycliste jour et nuit. Nous y intervenons souvent le soir et le week-end. Lochergut et Bäckeranlage sont des points de rendez-vous classiques pour nos réparations sur place."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Autour de Helvetiaplatz, Lochergut et le long de la Langstrasse – d'innombrables réparations le jour même pour cafés, bars et résidents. Helvetiaplatz · Lochergut · Stauffacher · Volkshaus · Langstrasse · Bäckeranlage · Kanzleiareal · Kasernenwiese"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Aussersihl ?",
        "a": "Habituellement 20–40 minutes après la réservation WhatsApp – Aussersihl est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 4 ?",
        "a": "Toutes les adresses du Kreis 4 (8004), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Aussersihl dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Aussersihl (Kreis 4) · info@velov.ch"
  },
  "IT": {
    "id": "aussersihl_it",
    "h1": "Meccanico bici mobile Aussersihl – Riparazione bici Kreis 4 (sul posto)",
    "intro": "Foratura a Aussersihl? VELOV è la tua officina mobile nel Kreis 4, di solito sul posto in 35 minuti. Zona di servizio: Helvetiaplatz, Lochergut, Stauffacher, Volkshaus, Langstrasse, Bäckeranlage.",
    "sections": [
      {
        "h2": "Aussersihl – conosciamo il quartiere",
        "body": "Aussersihl – la Langstrasse, Helvetiaplatz, Hardplatz. Quartiere urbano denso con molto traffico ciclistico giorno e notte. Interveniamo spesso anche la sera e nei weekend. Lochergut e Bäckeranlage sono classici punti d'incontro per le riparazioni sul posto."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Intorno a Helvetiaplatz, Lochergut e lungo la Langstrasse – innumerevoli riparazioni in giornata per caffè, bar e residenti. Helvetiaplatz · Lochergut · Stauffacher · Volkshaus · Langstrasse · Bäckeranlage · Kanzleiareal · Kasernenwiese"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Aussersihl?",
        "a": "Di solito 20–40 minuti dalla prenotazione WhatsApp – Aussersihl è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 4?",
        "a": "Tutti gli indirizzi del Kreis 4 (8004), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Aussersihl da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Aussersihl (Kreis 4) · info@velov.ch"
  },
  "ES": {
    "id": "aussersihl_es",
    "h1": "Mecánico de bici móvil Aussersihl – Reparación de bicicleta Kreis 4 (in situ)",
    "intro": "¿Pinchazo en Aussersihl? VELOV es tu taller móvil de bicis en el Kreis 4, normalmente en el lugar en 35 minutos. Zona de servicio: Helvetiaplatz, Lochergut, Stauffacher, Volkshaus, Langstrasse, Bäckeranlage.",
    "sections": [
      {
        "h2": "Aussersihl – conocemos el barrio",
        "body": "Aussersihl – la Langstrasse, Helvetiaplatz, Hardplatz. Barrio urbano denso con mucho tráfico ciclista día y noche. Trabajamos aquí a menudo por la tarde y los fines de semana. Lochergut y Bäckeranlage son puntos clásicos de encuentro para nuestras reparaciones in situ."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Alrededor de Helvetiaplatz, Lochergut y a lo largo de la Langstrasse – innumerables reparaciones el mismo día para cafés, bares y vecinos. Helvetiaplatz · Lochergut · Stauffacher · Volkshaus · Langstrasse · Bäckeranlage · Kanzleiareal · Kasernenwiese"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Aussersihl?",
        "a": "Normalmente 20–40 minutos tras la reserva por WhatsApp – Aussersihl está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 4?",
        "a": "Todas las direcciones del Kreis 4 (8004), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Aussersihl desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Aussersihl (Kreis 4) · info@velov.ch"
  }
};

const VELOV_SEO_AUSSERSIHL_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Aussersihl – Velo-Reparatur Kreis 4 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Aussersihl, Kreis 4 (8004). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 4 · Ø 35 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Aussersihl",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Aussersihl buchen →",
    "sectionServices": "Services in Aussersihl",
    "sectionWhy": "Warum VELOV in Aussersihl?",
    "sectionCommon": "Häufige Probleme in Aussersihl — VELOV Lösung",
    "sectionStory": "Aussersihl – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Aussersihl?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Aussersihl)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Aussersihl und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Aussersihl. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Aussersihl in 30 Min.",
    ...
    "story": "Aussersihl – die Langstrasse, Helvetiaplatz, Hardplatz. Dichtes urbanes Quartier mit viel Velo-Verkehr Tag und Nacht. Wir reparieren hier oft auch abends und am Wochenende. Lochergut und Bäckeranlage sind klassische Treffpunkte für unsere Vor-Ort-Reparaturen.",
    "storyShort": "In der Nähe vom Helvetiaplatz, am Lochergut und an der Langstrasse haben wir schon unzählige Same-day-Reparaturen für Cafés, Bars und Anwohnerinnen gemacht."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Aussersihl – Bicycle Repair Kreis 4 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Aussersihl, Kreis 4 (8004). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 4 · Ø 35 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Aussersihl now →",
    "sectionServices": "Services in Aussersihl",
    "sectionWhy": "Why VELOV in Aussersihl?",
    "sectionCommon": "Common problems in Aussersihl — VELOV solution",
    "sectionStory": "Aussersihl – we know the area",
    "finalH2": "Bike broken in Aussersihl?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Aussersihl)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Aussersihl and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Aussersihl. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Aussersihl within 30 min.",
    ...
    "story": "Aussersihl – Langstrasse, Helvetiaplatz, Hardplatz. Dense urban district with heavy bike traffic day and night. We frequently work here in the evenings and on weekends. Lochergut and Bäckeranlage are classic meeting points for our on-site repairs.",
    "storyShort": "Around Helvetiaplatz, Lochergut and along Langstrasse we have done countless same-day repairs for cafés, bars and residents."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Aussersihl – Réparation vélo Kreis 4 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Aussersihl, Kreis 4 (8004). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 4 · ~35 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Aussersihl →",
    "sectionServices": "Services à Aussersihl",
    "sectionWhy": "Pourquoi VELOV à Aussersihl ?",
    "sectionCommon": "Problèmes fréquents à Aussersihl — solution VELOV",
    "sectionStory": "Aussersihl – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Aussersihl ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Aussersihl)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Aussersihl et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Aussersihl. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Aussersihl en 30 min.",
    ...
    "story": "Aussersihl – la Langstrasse, Helvetiaplatz, Hardplatz. Quartier urbain dense avec une forte circulation cycliste jour et nuit. Nous y intervenons souvent le soir et le week-end. Lochergut et Bäckeranlage sont des points de rendez-vous classiques pour nos réparations sur place.",
    "storyShort": "Autour de Helvetiaplatz, Lochergut et le long de la Langstrasse – d'innombrables réparations le jour même pour cafés, bars et résidents."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Aussersihl – Riparazione bici Kreis 4 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Aussersihl, Kreis 4 (8004). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 4 · ~35 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Aussersihl →",
    "sectionServices": "Servizi a Aussersihl",
    "sectionWhy": "Perché VELOV a Aussersihl?",
    "sectionCommon": "Problemi frequenti a Aussersihl — soluzione VELOV",
    "sectionStory": "Aussersihl – conosciamo il quartiere",
    "finalH2": "Bici rotta a Aussersihl?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Aussersihl)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Aussersihl e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Aussersihl. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Aussersihl in 30 min.",
    ...
    "story": "Aussersihl – la Langstrasse, Helvetiaplatz, Hardplatz. Quartiere urbano denso con molto traffico ciclistico giorno e notte. Interveniamo spesso anche la sera e nei weekend. Lochergut e Bäckeranlage sono classici punti d'incontro per le riparazioni sul posto.",
    "storyShort": "Intorno a Helvetiaplatz, Lochergut e lungo la Langstrasse – innumerevoli riparazioni in giornata per caffè, bar e residenti."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Aussersihl – Reparación de bicicleta Kreis 4 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Aussersihl, Kreis 4 (8004). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 4 · ~35 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Aussersihl →",
    "sectionServices": "Servicios en Aussersihl",
    "sectionWhy": "¿Por qué VELOV en Aussersihl?",
    "sectionCommon": "Problemas frecuentes en Aussersihl — solución VELOV",
    "sectionStory": "Aussersihl – conocemos el barrio",
    "finalH2": "¿Bici rota en Aussersihl?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Aussersihl)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Aussersihl y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Aussersihl. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Aussersihl en 30 min.",
    ...
    "story": "Aussersihl – la Langstrasse, Helvetiaplatz, Hardplatz. Barrio urbano denso con mucho tráfico ciclista día y noche. Trabajamos aquí a menudo por la tarde y los fines de semana. Lochergut y Bäckeranlage son puntos clásicos de encuentro para nuestras reparaciones in situ.",
    "storyShort": "Alrededor de Helvetiaplatz, Lochergut y a lo largo de la Langstrasse – innumerables reparaciones el mismo día para cafés, bares y vecinos."
  }
};

const VELOV_SEO_AUSSERSIHL_KREIS = {
  "id": "aussersihl",
  "slug": "aussersihl",
  "kreis": 4,
  "kreisLabel": "Kreis 4",
...
class VelovAussersihl extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      ...
      url: 'https://velov.ch/aussersihl',
      baseEta: 35,
      neighbours: [{ slug: 'altstadt', name: 'Altstadt' }, { slug: 'wiedikon', name: 'Wiedikon' }, { slug: 'industriequartier', name: 'Industriequartier' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_AUSSERSIHL_BY_LANG[this.lang] || VELOV_SEO_AUSSERSIHL_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-aussersihl-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-aussersihl { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-aussersihl *, velov-aussersihl *::before, velov-aussersihl *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovAussersihl.CONFIG;
    const T = VELOV_SEO_AUSSERSIHL_I18N[this.lang] || VELOV_SEO_AUSSERSIHL_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_AUSSERSIHL_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-aussersihl')) {
  customElements.define('velov-aussersihl', VelovAussersihl);
}
