  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'riesbach'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'riesbach'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'riesbach'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'riesbach'}, ctx));
      }
...
/* ===== VELOV — Kreis 8 Seefeld & Riesbach =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-riesbach lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_RIESBACH_BY_LANG = {
  "DE": {
    "id": "riesbach_de",
    "h1": "Mobiler Velomechaniker Seefeld & Riesbach – Velo-Reparatur Kreis 8 (vor Ort)",
    "intro": "Plattfuss in Seefeld & Riesbach? VELOV ist deine mobile Velowerkstatt im Kreis 8 und kommt in der Regel innert 40 Minuten zu dir. Servicegebiet u.a.: Bahnhof Tiefenbrunnen, Bellevue, Opernhaus, Chinagarten, Zürichhorn, Seefeldquai.",
    "sections": [
      {
        "h2": "Seefeld & Riesbach – wir kennen das Quartier",
        "body": "Kreis 8 – Seefeld, Zürichhorn, Bahnhof Tiefenbrunnen. Velo-Pendler, Familien, viele E-Bikes. Im Sommer sind wir täglich am Seeufer unterwegs. Vom Bellevue dem See entlang bis Tiefenbrunnen – das sind unsere Standard-Routen. Service direkt in der Tiefgarage oder beim Veloständer ist bei uns Standard."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Zürichhorn, an der Seefeldstrasse und am Bahnhof Tiefenbrunnen sind wir Stamm-Mechaniker für Wohnungen, Praxen und Boutique-Firmen. Bahnhof Tiefenbrunnen · Bellevue · Opernhaus · Chinagarten · Zürichhorn · Seefeldquai · Kreuzstrasse · Mühle Tiefenbrunnen"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Seefeld & Riesbach?",
        "a": "Meist 25–45 Minuten ab WhatsApp-Buchung – Seefeld & Riesbach ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 8 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 8 (8008) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Seefeld & Riesbach sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Seefeld & Riesbach (Kreis 8) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/seefeld-riesbach#business",
        "name": "VELOV — Mobile Velowerkstatt Seefeld & Riesbach",
        "url": "https://www.velov.ch/seefeld-riesbach",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": "https://www.velov.ch/seefeld-riesbach"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "riesbach_en",
    "h1": "Mobile Bike Mechanic Seefeld & Riesbach – Bicycle Repair Kreis 8 (on-site)",
    "intro": "Flat tyre in Seefeld & Riesbach? VELOV is your mobile bike workshop in Kreis 8, usually on-site within 40 minutes. Service area includes: Bahnhof Tiefenbrunnen, Bellevue, Opernhaus, Chinagarten, Zürichhorn, Seefeldquai.",
    "sections": [
      {
        "h2": "Seefeld & Riesbach – we know the area",
        "body": "Kreis 8 – Seefeld, Zürichhorn, Bahnhof Tiefenbrunnen. Bike commuters, families, many e-bikes. In summer we are out along the lake every day. From Bellevue along the shore to Tiefenbrunnen – these are our standard routes. Service directly in your underground garage or at the bike rack is our default."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Near Zürichhorn, along Seefeldstrasse and at Bahnhof Tiefenbrunnen we are regular mechanics for residences, clinics and boutique firms. Bahnhof Tiefenbrunnen · Bellevue · Opernhaus · Chinagarten · Zürichhorn · Seefeldquai · Kreuzstrasse · Mühle Tiefenbrunnen"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Seefeld & Riesbach?",
        "a": "Usually 25–45 minutes after WhatsApp booking – Seefeld & Riesbach is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 8?",
        "a": "We serve all addresses in Kreis 8 (8008) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Seefeld & Riesbach bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Seefeld & Riesbach (Kreis 8) · info@velov.ch"
  },
  "FR": {
    "id": "riesbach_fr",
    "h1": "Mécanicien vélo mobile Seefeld & Riesbach – Réparation vélo Kreis 8 (sur place)",
    "intro": "Crevaison à Seefeld & Riesbach ? VELOV est votre atelier vélo mobile dans le Kreis 8, généralement sur place en 40 minutes. Zone de service : Bahnhof Tiefenbrunnen, Bellevue, Opernhaus, Chinagarten, Zürichhorn, Seefeldquai.",
    "sections": [
      {
        "h2": "Seefeld & Riesbach – nous connaissons le quartier",
        "body": "Kreis 8 – Seefeld, Zürichhorn, gare Tiefenbrunnen. Pendulaires à vélo, familles, beaucoup de e-bikes. En été, chaque jour le long du lac. De Bellevue à Tiefenbrunnen – nos itinéraires standards. Service directement dans le garage souterrain ou au support à vélos."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Près du Zürichhorn, le long de la Seefeldstrasse et à la gare Tiefenbrunnen – mécaniciens réguliers pour résidences, cabinets et boutiques. Bahnhof Tiefenbrunnen · Bellevue · Opernhaus · Chinagarten · Zürichhorn · Seefeldquai · Kreuzstrasse · Mühle Tiefenbrunnen"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Seefeld & Riesbach ?",
        "a": "Habituellement 25–45 minutes après la réservation WhatsApp – Seefeld & Riesbach est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 8 ?",
        "a": "Toutes les adresses du Kreis 8 (8008), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Seefeld & Riesbach dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Seefeld & Riesbach (Kreis 8) · info@velov.ch"
  },
  "IT": {
    "id": "riesbach_it",
    "h1": "Meccanico bici mobile Seefeld & Riesbach – Riparazione bici Kreis 8 (sul posto)",
    "intro": "Foratura a Seefeld & Riesbach? VELOV è la tua officina mobile nel Kreis 8, di solito sul posto in 40 minuti. Zona di servizio: Bahnhof Tiefenbrunnen, Bellevue, Opernhaus, Chinagarten, Zürichhorn, Seefeldquai.",
    "sections": [
      {
        "h2": "Seefeld & Riesbach – conosciamo il quartiere",
        "body": "Kreis 8 – Seefeld, Zürichhorn, stazione Tiefenbrunnen. Pendolari in bici, famiglie, molte e-bike. D'estate ogni giorno lungo il lago. Da Bellevue a Tiefenbrunnen – itinerari standard. Servizio direttamente nel garage sotterraneo o al portabici."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Vicino allo Zürichhorn, lungo la Seefeldstrasse e alla stazione Tiefenbrunnen – meccanici abituali per residenze, studi e boutique. Bahnhof Tiefenbrunnen · Bellevue · Opernhaus · Chinagarten · Zürichhorn · Seefeldquai · Kreuzstrasse · Mühle Tiefenbrunnen"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Seefeld & Riesbach?",
        "a": "Di solito 25–45 minuti dalla prenotazione WhatsApp – Seefeld & Riesbach è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 8?",
        "a": "Tutti gli indirizzi del Kreis 8 (8008), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Seefeld & Riesbach da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Seefeld & Riesbach (Kreis 8) · info@velov.ch"
  },
  "ES": {
    "id": "riesbach_es",
    "h1": "Mecánico de bici móvil Seefeld & Riesbach – Reparación de bicicleta Kreis 8 (in situ)",
    "intro": "¿Pinchazo en Seefeld & Riesbach? VELOV es tu taller móvil de bicis en el Kreis 8, normalmente en el lugar en 40 minutos. Zona de servicio: Bahnhof Tiefenbrunnen, Bellevue, Opernhaus, Chinagarten, Zürichhorn, Seefeldquai.",
    "sections": [
      {
        "h2": "Seefeld & Riesbach – conocemos el barrio",
        "body": "Kreis 8 – Seefeld, Zürichhorn, estación Tiefenbrunnen. Pendulares en bici, familias, muchas e-bikes. En verano, cada día junto al lago. De Bellevue a Tiefenbrunnen – rutas estándar. Servicio directamente en el garaje subterráneo o el aparcabicis."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Cerca del Zürichhorn, a lo largo de la Seefeldstrasse y en Bahnhof Tiefenbrunnen – mecánicos habituales para viviendas, consultas y boutiques. Bahnhof Tiefenbrunnen · Bellevue · Opernhaus · Chinagarten · Zürichhorn · Seefeldquai · Kreuzstrasse · Mühle Tiefenbrunnen"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Seefeld & Riesbach?",
        "a": "Normalmente 25–45 minutos tras la reserva por WhatsApp – Seefeld & Riesbach está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 8?",
        "a": "Todas las direcciones del Kreis 8 (8008), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Seefeld & Riesbach desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Seefeld & Riesbach (Kreis 8) · info@velov.ch"
  }
};

const VELOV_SEO_RIESBACH_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Seefeld & Riesbach – Velo-Reparatur Kreis 8 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Seefeld & Riesbach, Kreis 8 (8008). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 8 · Ø 40 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Seefeld & Riesbach",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Seefeld & Riesbach buchen →",
    "sectionServices": "Services in Seefeld & Riesbach",
    "sectionWhy": "Warum VELOV in Seefeld & Riesbach?",
    "sectionCommon": "Häufige Probleme in Seefeld & Riesbach — VELOV Lösung",
    "sectionStory": "Seefeld & Riesbach – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Seefeld & Riesbach?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Seefeld & Riesbach)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Seefeld & Riesbach und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Seefeld & Riesbach. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Seefeld & Riesbach in 30 Min.",
    ...
    "story": "Kreis 8 – Seefeld, Zürichhorn, Bahnhof Tiefenbrunnen. Velo-Pendler, Familien, viele E-Bikes. Im Sommer sind wir täglich am Seeufer unterwegs. Vom Bellevue dem See entlang bis Tiefenbrunnen – das sind unsere Standard-Routen. Service direkt in der Tiefgarage oder beim Veloständer ist bei uns Standard.",
    "storyShort": "In der Nähe vom Zürichhorn, an der Seefeldstrasse und am Bahnhof Tiefenbrunnen sind wir Stamm-Mechaniker für Wohnungen, Praxen und Boutique-Firmen."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Seefeld & Riesbach – Bicycle Repair Kreis 8 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Seefeld & Riesbach, Kreis 8 (8008). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 8 · Ø 40 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Seefeld & Riesbach now →",
    "sectionServices": "Services in Seefeld & Riesbach",
    "sectionWhy": "Why VELOV in Seefeld & Riesbach?",
    "sectionCommon": "Common problems in Seefeld & Riesbach — VELOV solution",
    "sectionStory": "Seefeld & Riesbach – we know the area",
    "finalH2": "Bike broken in Seefeld & Riesbach?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Seefeld & Riesbach)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Seefeld & Riesbach and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Seefeld & Riesbach. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Seefeld & Riesbach within 30 min.",
    ...
    "story": "Kreis 8 – Seefeld, Zürichhorn, Bahnhof Tiefenbrunnen. Bike commuters, families, many e-bikes. In summer we are out along the lake every day. From Bellevue along the shore to Tiefenbrunnen – these are our standard routes. Service directly in your underground garage or at the bike rack is our default.",
    "storyShort": "Near Zürichhorn, along Seefeldstrasse and at Bahnhof Tiefenbrunnen we are regular mechanics for residences, clinics and boutique firms."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Seefeld & Riesbach – Réparation vélo Kreis 8 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Seefeld & Riesbach, Kreis 8 (8008). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 8 · ~40 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Seefeld & Riesbach →",
    "sectionServices": "Services à Seefeld & Riesbach",
    "sectionWhy": "Pourquoi VELOV à Seefeld & Riesbach ?",
    "sectionCommon": "Problèmes fréquents à Seefeld & Riesbach — solution VELOV",
    "sectionStory": "Seefeld & Riesbach – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Seefeld & Riesbach ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Seefeld & Riesbach)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Seefeld & Riesbach et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Seefeld & Riesbach. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Seefeld & Riesbach en 30 min.",
    ...
    "story": "Kreis 8 – Seefeld, Zürichhorn, gare Tiefenbrunnen. Pendulaires à vélo, familles, beaucoup de e-bikes. En été, chaque jour le long du lac. De Bellevue à Tiefenbrunnen – nos itinéraires standards. Service directement dans le garage souterrain ou au support à vélos.",
    "storyShort": "Près du Zürichhorn, le long de la Seefeldstrasse et à la gare Tiefenbrunnen – mécaniciens réguliers pour résidences, cabinets et boutiques."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Seefeld & Riesbach – Riparazione bici Kreis 8 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Seefeld & Riesbach, Kreis 8 (8008). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 8 · ~40 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Seefeld & Riesbach →",
    "sectionServices": "Servizi a Seefeld & Riesbach",
    "sectionWhy": "Perché VELOV a Seefeld & Riesbach?",
    "sectionCommon": "Problemi frequenti a Seefeld & Riesbach — soluzione VELOV",
    "sectionStory": "Seefeld & Riesbach – conosciamo il quartiere",
    "finalH2": "Bici rotta a Seefeld & Riesbach?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Seefeld & Riesbach)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Seefeld & Riesbach e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Seefeld & Riesbach. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Seefeld & Riesbach in 30 min.",
    ...
    "story": "Kreis 8 – Seefeld, Zürichhorn, stazione Tiefenbrunnen. Pendolari in bici, famiglie, molte e-bike. D'estate ogni giorno lungo il lago. Da Bellevue a Tiefenbrunnen – itinerari standard. Servizio direttamente nel garage sotterraneo o al portabici.",
    "storyShort": "Vicino allo Zürichhorn, lungo la Seefeldstrasse e alla stazione Tiefenbrunnen – meccanici abituali per residenze, studi e boutique."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Seefeld & Riesbach – Reparación de bicicleta Kreis 8 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Seefeld & Riesbach, Kreis 8 (8008). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 8 · ~40 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Seefeld & Riesbach →",
    "sectionServices": "Servicios en Seefeld & Riesbach",
    "sectionWhy": "¿Por qué VELOV en Seefeld & Riesbach?",
    "sectionCommon": "Problemas frecuentes en Seefeld & Riesbach — solución VELOV",
    "sectionStory": "Seefeld & Riesbach – conocemos el barrio",
    "finalH2": "¿Bici rota en Seefeld & Riesbach?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Seefeld & Riesbach)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Seefeld & Riesbach y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Seefeld & Riesbach. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Seefeld & Riesbach en 30 min.",
    ...
    "story": "Kreis 8 – Seefeld, Zürichhorn, estación Tiefenbrunnen. Pendulares en bici, familias, muchas e-bikes. En verano, cada día junto al lago. De Bellevue a Tiefenbrunnen – rutas estándar. Servicio directamente en el garaje subterráneo o el aparcabicis.",
    "storyShort": "Cerca del Zürichhorn, a lo largo de la Seefeldstrasse y en Bahnhof Tiefenbrunnen – mecánicos habituales para viviendas, consultas y boutiques."
  }
};

const VELOV_SEO_RIESBACH_KREIS = {
  "id": "riesbach",
  "slug": "seefeld-riesbach",
  "kreis": 8,
  "kreisLabel": "Kreis 8",
  "plz": [
    "8008"
...
class VelovRiesbach extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      ...
      url: 'https://velov.ch/seefeld-riesbach',
      baseEta: 40,
      neighbours: [{ slug: 'altstadt', name: 'Altstadt' }, { slug: 'hottingen-witikon', name: 'Hottingen, Hirslanden & Witikon' }, { slug: 'enge', name: 'Enge & Wollishofen' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_RIESBACH_BY_LANG[this.lang] || VELOV_SEO_RIESBACH_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-riesbach-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-riesbach { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-riesbach *, velov-riesbach *::before, velov-riesbach *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovRiesbach.CONFIG;
    const T = VELOV_SEO_RIESBACH_I18N[this.lang] || VELOV_SEO_RIESBACH_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_RIESBACH_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-riesbach')) {
  customElements.define('velov-riesbach', VelovRiesbach);
}
