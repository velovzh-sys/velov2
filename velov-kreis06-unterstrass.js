  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'unterstrass'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'unterstrass'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'unterstrass'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'unterstrass'}, ctx));
      }
...
/* ===== VELOV — Kreis 6 Unterstrass & Oberstrass =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-unterstrass lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_UNTERSTRASS_BY_LANG = {
  "DE": {
    "id": "unterstrass_de",
    "h1": "Mobiler Velomechaniker Unterstrass & Oberstrass – Velo-Reparatur Kreis 6 (vor Ort)",
    "intro": "Plattfuss in Unterstrass & Oberstrass? VELOV ist deine mobile Velowerkstatt im Kreis 6 und kommt in der Regel innert 45 Minuten zu dir. Servicegebiet u.a.: ETH Hönggerberg, Universität Irchel, Schaffhauserplatz, Milchbuck, Röschibachplatz, Bucheggplatz.",
    "sections": [
      {
        "h2": "Unterstrass & Oberstrass – wir kennen das Quartier",
        "body": "Kreis 6 – ETH Hönggerberg, Universität Irchel, Schaffhauserplatz. Studierende, Forschende, Profis. Viele Pannendienste rund um den Schaffhauserplatz und Bucheggplatz. Der Hügel zum Käferberg und Hönggerberg verlangt gute Schaltung – wir machen oft Komplett-Wartungen für Studierende vor dem Semesterstart."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe der ETH Hönggerberg, Universität Irchel und am Schaffhauserplatz haben wir regelmässig Studierende und Forschende als Stammkundschaft. ETH Hönggerberg · Universität Irchel · Schaffhauserplatz · Milchbuck · Röschibachplatz · Bucheggplatz · Käferberg · Zoo Zürich (Nähe)"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Unterstrass & Oberstrass?",
        "a": "Meist 30–50 Minuten ab WhatsApp-Buchung – Unterstrass & Oberstrass ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 6 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 6 (8006, 8044, 8057) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Unterstrass & Oberstrass sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Unterstrass & Oberstrass (Kreis 6) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/unterstrass-oberstrass#business",
        "name": "VELOV — Mobile Velowerkstatt Unterstrass & Oberstrass",
        "url": "https://www.velov.ch/unterstrass-oberstrass",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Unterstrass & Oberstrass",
            "item": "https://www.velov.ch/unterstrass-oberstrass"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "unterstrass_en",
    "h1": "Mobile Bike Mechanic Unterstrass & Oberstrass – Bicycle Repair Kreis 6 (on-site)",
    "intro": "Flat tyre in Unterstrass & Oberstrass? VELOV is your mobile bike workshop in Kreis 6, usually on-site within 45 minutes. Service area includes: ETH Hönggerberg, Universität Irchel, Schaffhauserplatz, Milchbuck, Röschibachplatz, Bucheggplatz.",
    "sections": [
      {
        "h2": "Unterstrass & Oberstrass – we know the area",
        "body": "Kreis 6 – ETH Hönggerberg, University of Zürich Irchel, Schaffhauserplatz. Students, researchers, professionals. Many emergency calls around Schaffhauserplatz and Bucheggplatz. The hill up to Käferberg and Hönggerberg demands a clean drivetrain – we frequently do full services for students before the semester starts."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Around ETH Hönggerberg, University Irchel and Schaffhauserplatz, students and researchers are regular customers. ETH Hönggerberg · Universität Irchel · Schaffhauserplatz · Milchbuck · Röschibachplatz · Bucheggplatz · Käferberg · Zoo Zürich (Nähe)"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Unterstrass & Oberstrass?",
        "a": "Usually 30–50 minutes after WhatsApp booking – Unterstrass & Oberstrass is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 6?",
        "a": "We serve all addresses in Kreis 6 (8006, 8044, 8057) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Unterstrass & Oberstrass bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Unterstrass & Oberstrass (Kreis 6) · info@velov.ch"
  },
  "FR": {
    "id": "unterstrass_fr",
    "h1": "Mécanicien vélo mobile Unterstrass & Oberstrass – Réparation vélo Kreis 6 (sur place)",
    "intro": "Crevaison à Unterstrass & Oberstrass ? VELOV est votre atelier vélo mobile dans le Kreis 6, généralement sur place en 45 minutes. Zone de service : ETH Hönggerberg, Universität Irchel, Schaffhauserplatz, Milchbuck, Röschibachplatz, Bucheggplatz.",
    "sections": [
      {
        "h2": "Unterstrass & Oberstrass – nous connaissons le quartier",
        "body": "Kreis 6 – EPF Hönggerberg, Université Irchel, Schaffhauserplatz. Étudiants, chercheurs, professionnels. Nombreuses interventions d'urgence autour de Schaffhauserplatz et Bucheggplatz. La montée vers Käferberg et Hönggerberg exige une bonne transmission – nous faisons souvent des services complets pour étudiants avant la rentrée."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Autour de l'EPF Hönggerberg, l'Université Irchel et le Schaffhauserplatz – étudiants et chercheurs sont des clients réguliers. ETH Hönggerberg · Universität Irchel · Schaffhauserplatz · Milchbuck · Röschibachplatz · Bucheggplatz · Käferberg · Zoo Zürich (Nähe)"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Unterstrass & Oberstrass ?",
        "a": "Habituellement 30–50 minutes après la réservation WhatsApp – Unterstrass & Oberstrass est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 6 ?",
        "a": "Toutes les adresses du Kreis 6 (8006, 8044, 8057), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Unterstrass & Oberstrass dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Unterstrass & Oberstrass (Kreis 6) · info@velov.ch"
  },
  "IT": {
    "id": "unterstrass_it",
    "h1": "Meccanico bici mobile Unterstrass & Oberstrass – Riparazione bici Kreis 6 (sul posto)",
    "intro": "Foratura a Unterstrass & Oberstrass? VELOV è la tua officina mobile nel Kreis 6, di solito sul posto in 45 minuti. Zona di servizio: ETH Hönggerberg, Universität Irchel, Schaffhauserplatz, Milchbuck, Röschibachplatz, Bucheggplatz.",
    "sections": [
      {
        "h2": "Unterstrass & Oberstrass – conosciamo il quartiere",
        "body": "Kreis 6 – ETH Hönggerberg, Università Irchel, Schaffhauserplatz. Studenti, ricercatori, professionisti. Molti interventi d'emergenza intorno a Schaffhauserplatz e Bucheggplatz. La salita al Käferberg e Hönggerberg richiede una buona trasmissione – spesso servizi completi per studenti prima del semestre."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Intorno all'ETH Hönggerberg, Università Irchel e Schaffhauserplatz – studenti e ricercatori sono clienti abituali. ETH Hönggerberg · Universität Irchel · Schaffhauserplatz · Milchbuck · Röschibachplatz · Bucheggplatz · Käferberg · Zoo Zürich (Nähe)"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Unterstrass & Oberstrass?",
        "a": "Di solito 30–50 minuti dalla prenotazione WhatsApp – Unterstrass & Oberstrass è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 6?",
        "a": "Tutti gli indirizzi del Kreis 6 (8006, 8044, 8057), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Unterstrass & Oberstrass da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Unterstrass & Oberstrass (Kreis 6) · info@velov.ch"
  },
  "ES": {
    "id": "unterstrass_es",
    "h1": "Mecánico de bici móvil Unterstrass & Oberstrass – Reparación de bicicleta Kreis 6 (in situ)",
    "intro": "¿Pinchazo en Unterstrass & Oberstrass? VELOV es tu taller móvil de bicis en el Kreis 6, normalmente en el lugar en 45 minutos. Zona de servicio: ETH Hönggerberg, Universität Irchel, Schaffhauserplatz, Milchbuck, Röschibachplatz, Bucheggplatz.",
    "sections": [
      {
        "h2": "Unterstrass & Oberstrass – conocemos el barrio",
        "body": "Kreis 6 – ETH Hönggerberg, Universidad Irchel, Schaffhauserplatz. Estudiantes, investigadores, profesionales. Muchas urgencias alrededor de Schaffhauserplatz y Bucheggplatz. La subida al Käferberg y Hönggerberg exige buena transmisión – servicios completos para estudiantes antes del semestre."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Alrededor de ETH Hönggerberg, Universidad Irchel y Schaffhauserplatz – estudiantes e investigadores son clientes habituales. ETH Hönggerberg · Universität Irchel · Schaffhauserplatz · Milchbuck · Röschibachplatz · Bucheggplatz · Käferberg · Zoo Zürich (Nähe)"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Unterstrass & Oberstrass?",
        "a": "Normalmente 30–50 minutos tras la reserva por WhatsApp – Unterstrass & Oberstrass está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 6?",
        "a": "Todas las direcciones del Kreis 6 (8006, 8044, 8057), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Unterstrass & Oberstrass desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Unterstrass & Oberstrass (Kreis 6) · info@velov.ch"
  }
};

const VELOV_SEO_UNTERSTRASS_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Unterstrass & Oberstrass – Velo-Reparatur Kreis 6 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Unterstrass & Oberstrass, Kreis 6 (8006, 8044, 8057). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 6 · Ø 45 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Unterstrass & Oberstrass",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Unterstrass & Oberstrass buchen →",
    "sectionServices": "Services in Unterstrass & Oberstrass",
    "sectionWhy": "Warum VELOV in Unterstrass & Oberstrass?",
    "sectionCommon": "Häufige Probleme in Unterstrass & Oberstrass — VELOV Lösung",
    "sectionStory": "Unterstrass & Oberstrass – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Unterstrass & Oberstrass?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Unterstrass & Oberstrass)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Unterstrass & Oberstrass und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Unterstrass & Oberstrass. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Unterstrass & Oberstrass in 30 Min.",
    ...
    "story": "Kreis 6 – ETH Hönggerberg, Universität Irchel, Schaffhauserplatz. Studierende, Forschende, Profis. Viele Pannendienste rund um den Schaffhauserplatz und Bucheggplatz. Der Hügel zum Käferberg und Hönggerberg verlangt gute Schaltung – wir machen oft Komplett-Wartungen für Studierende vor dem Semesterstart.",
    "storyShort": "In der Nähe der ETH Hönggerberg, Universität Irchel und am Schaffhauserplatz haben wir regelmässig Studierende und Forschende als Stammkundschaft."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Unterstrass & Oberstrass – Bicycle Repair Kreis 6 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Unterstrass & Oberstrass, Kreis 6 (8006, 8044, 8057). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 6 · Ø 45 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Unterstrass & Oberstrass now →",
    "sectionServices": "Services in Unterstrass & Oberstrass",
    "sectionWhy": "Why VELOV in Unterstrass & Oberstrass?",
    "sectionCommon": "Common problems in Unterstrass & Oberstrass — VELOV solution",
    "sectionStory": "Unterstrass & Oberstrass – we know the area",
    "finalH2": "Bike broken in Unterstrass & Oberstrass?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Unterstrass & Oberstrass)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Unterstrass & Oberstrass and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Unterstrass & Oberstrass. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Unterstrass & Oberstrass within 30 min.",
    ...
    "story": "Kreis 6 – ETH Hönggerberg, University of Zürich Irchel, Schaffhauserplatz. Students, researchers, professionals. Many emergency calls around Schaffhauserplatz and Bucheggplatz. The hill up to Käferberg and Hönggerberg demands a clean drivetrain – we frequently do full services for students before the semester starts.",
    "storyShort": "Around ETH Hönggerberg, University Irchel and Schaffhauserplatz, students and researchers are regular customers."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Unterstrass & Oberstrass – Réparation vélo Kreis 6 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Unterstrass & Oberstrass, Kreis 6 (8006, 8044, 8057). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 6 · ~45 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Unterstrass & Oberstrass →",
    "sectionServices": "Services à Unterstrass & Oberstrass",
    "sectionWhy": "Pourquoi VELOV à Unterstrass & Oberstrass ?",
    "sectionCommon": "Problèmes fréquents à Unterstrass & Oberstrass — solution VELOV",
    "sectionStory": "Unterstrass & Oberstrass – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Unterstrass & Oberstrass ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Unterstrass & Oberstrass)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Unterstrass & Oberstrass et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Unterstrass & Oberstrass. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Unterstrass & Oberstrass en 30 min.",
    ...
    "story": "Kreis 6 – EPF Hönggerberg, Université Irchel, Schaffhauserplatz. Étudiants, chercheurs, professionnels. Nombreuses interventions d'urgence autour de Schaffhauserplatz et Bucheggplatz. La montée vers Käferberg et Hönggerberg exige une bonne transmission – nous faisons souvent des services complets pour étudiants avant la rentrée.",
    "storyShort": "Autour de l'EPF Hönggerberg, l'Université Irchel et le Schaffhauserplatz – étudiants et chercheurs sont des clients réguliers."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Unterstrass & Oberstrass – Riparazione bici Kreis 6 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Unterstrass & Oberstrass, Kreis 6 (8006, 8044, 8057). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 6 · ~45 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Unterstrass & Oberstrass →",
    "sectionServices": "Servizi a Unterstrass & Oberstrass",
    "sectionWhy": "Perché VELOV a Unterstrass & Oberstrass?",
    "sectionCommon": "Problemi frequenti a Unterstrass & Oberstrass — soluzione VELOV",
    "sectionStory": "Unterstrass & Oberstrass – conosciamo il quartiere",
    "finalH2": "Bici rotta a Unterstrass & Oberstrass?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Unterstrass & Oberstrass)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Unterstrass & Oberstrass e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Unterstrass & Oberstrass. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Unterstrass & Oberstrass in 30 min.",
    ...
    "story": "Kreis 6 – ETH Hönggerberg, Università Irchel, Schaffhauserplatz. Studenti, ricercatori, professionisti. Molti interventi d'emergenza intorno a Schaffhauserplatz e Bucheggplatz. La salita al Käferberg e Hönggerberg richiede una buona trasmissione – spesso servizi completi per studenti prima del semestre.",
    "storyShort": "Intorno all'ETH Hönggerberg, Università Irchel e Schaffhauserplatz – studenti e ricercatori sono clienti abituali."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Unterstrass & Oberstrass – Reparación de bicicleta Kreis 6 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Unterstrass & Oberstrass, Kreis 6 (8006, 8044, 8057). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 6 · ~45 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Unterstrass & Oberstrass →",
    "sectionServices": "Servicios en Unterstrass & Oberstrass",
    "sectionWhy": "¿Por qué VELOV en Unterstrass & Oberstrass?",
    "sectionCommon": "Problemas frecuentes en Unterstrass & Oberstrass — solución VELOV",
    "sectionStory": "Unterstrass & Oberstrass – conocemos el barrio",
    "finalH2": "¿Bici rota en Unterstrass & Oberstrass?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Unterstrass & Oberstrass)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Unterstrass & Oberstrass y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Unterstrass & Oberstrass. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Unterstrass & Oberstrass en 30 min.",
    ...
    "story": "Kreis 6 – ETH Hönggerberg, Universidad Irchel, Schaffhauserplatz. Estudiantes, investigadores, profesionales. Muchas urgencias alrededor de Schaffhauserplatz y Bucheggplatz. La subida al Käferberg y Hönggerberg exige buena transmisión – servicios completos para estudiantes antes del semestre.",
    "storyShort": "Alrededor de ETH Hönggerberg, Universidad Irchel y Schaffhauserplatz – estudiantes e investigadores son clientes habituales."
  }
};

const VELOV_SEO_UNTERSTRASS_KREIS = {
  "id": "unterstrass",
  "slug": "unterstrass-oberstrass",
  "kreis": 6,
  "kreisLabel": "Kreis 6",
  "plz": [
    "8006",
...
class VelovUnterstrass extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      ...
      url: 'https://velov.ch/unterstrass-oberstrass',
      baseEta: 45,
      neighbours: [{ slug: 'altstadt', name: 'Altstadt' }, { slug: 'industriequartier', name: 'Industriequartier' }, { slug: 'wipkingen-hoengg', name: 'Wipkingen & Höngg' }, { slug: 'hottingen-witikon', name: 'Hottingen, Hirslanden & Witikon' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_UNTERSTRASS_BY_LANG[this.lang] || VELOV_SEO_UNTERSTRASS_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-unterstrass-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-unterstrass { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-unterstrass *, velov-unterstrass *::before, velov-unterstrass *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovUnterstrass.CONFIG;
    const T = VELOV_SEO_UNTERSTRASS_I18N[this.lang] || VELOV_SEO_UNTERSTRASS_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_UNTERSTRASS_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-unterstrass')) {
  customElements.define('velov-unterstrass', VelovUnterstrass);
}
