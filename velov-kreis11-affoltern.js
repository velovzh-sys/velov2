  ...
  function bind(host){
    ...
    host.addEventListener('click', function(e){
      ...
      if (/^https?:\/\/(?:wa\.me|api\.whatsapp\.com)/i.test(href) || /whatsapp/i.test(href)) {
        pushEvent('whatsapp_click', Object.assign({link_url: href, link_text: label, kreis: 'affoltern'}, ctx));
      } else if (/^tel:/i.test(href)) {
        pushEvent('phone_click', Object.assign({link_url: href, link_text: label, kreis: 'affoltern'}, ctx));
      } else if (/^mailto:/i.test(href)) {
        pushEvent('email_click', Object.assign({link_url: href, link_text: label, kreis: 'affoltern'}, ctx));
      } else if (/booking|termin|offerte/i.test(href + ' ' + label)) {
        pushEvent('booking_click', Object.assign({link_url: href, link_text: label, kreis: 'affoltern'}, ctx));
      }
...
/* ===== VELOV — Kreis 11 Affoltern, Oerlikon & Seebach =====
 * Multilingual Wix Custom Element — DE / EN / FR / IT / ES
 * Detects language via:
 *   1. <velov-affoltern lang="en"> attribute
 *   2. <html lang="..."> attribute
 *   3. window.__VELOV_LANG__ override
 *   4. Fallback: DE
 * ============================================================ */

const VELOV_SEO_AFFOLTERN_BY_LANG = {
  "DE": {
    "id": "affoltern_de",
    "h1": "Mobiler Velomechaniker Affoltern, Oerlikon & Seebach – Velo-Reparatur Kreis 11 (vor Ort)",
    "intro": "Plattfuss in Affoltern, Oerlikon & Seebach? VELOV ist deine mobile Velowerkstatt im Kreis 11 und kommt in der Regel innert 55 Minuten zu dir. Servicegebiet u.a.: Bahnhof Oerlikon, Marktplatz Oerlikon, Hallenstadion, Messe Zürich, Sternen Oerlikon, MFO-Park.",
    "sections": [
      {
        "h2": "Affoltern, Oerlikon & Seebach – wir kennen das Quartier",
        "body": "Kreis 11 – Oerlikon ist heute fast eine eigene Stadt mit Bahnhof Oerlikon, Hallenstadion, Messe Zürich. Affoltern und Seebach wachsen schnell, viele neue Wohnsiedlungen mit Veloräumen. Wir sind hier oft mehrmals pro Woche für Wartungen und Plattfuss-Einsätze. MFO-Park und Marktplatz Oerlikon sind klassische Treffpunkte."
      },
      {
        "h2": "Hotspots im Quartier",
        "body": "In der Nähe vom Bahnhof Oerlikon, am Hallenstadion und am MFO-Park machen wir regelmässig grosse B2B-Aktionstage – Oerlikon ist mit seinen Hochhaus-Wohnungen ideal für unser Modell. Bahnhof Oerlikon · Marktplatz Oerlikon · Hallenstadion · Messe Zürich · Sternen Oerlikon · MFO-Park · Bahnhof Affoltern · Bahnhof Seebach"
      }
    ],
    "faqs": [
      {
        "q": "Wie schnell seid ihr in Affoltern, Oerlikon & Seebach?",
        "a": "Meist 40–60 Minuten ab WhatsApp-Buchung – Affoltern, Oerlikon & Seebach ist regelmässig in unserer Tagesroute."
      },
      {
        "q": "Welche PLZ deckt ihr im Kreis 11 ab?",
        "a": "Wir bedienen alle Adressen im Kreis 11 (8046, 8050, 8052) ohne Aufschlag im Stadtgebiet."
      },
      {
      ...
      },
      {
        ...
        "a": "Ja – B2B-Aktionstage in Affoltern, Oerlikon & Seebach sind ab CHF 49 Anfahrt buchbar. Mehr unter velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 für Plattfuss-Notfälle in Affoltern, Oerlikon & Seebach (Kreis 11) · info@velov.ch",
    "schema": [
      {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "@id": "https://www.velov.ch/affoltern-oerlikon-seebach#business",
        "name": "VELOV — Mobile Velowerkstatt Affoltern, Oerlikon & Seebach",
        "url": "https://www.velov.ch/affoltern-oerlikon-seebach",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Affoltern, Oerlikon & Seebach",
            "item": "https://www.velov.ch/affoltern-oerlikon-seebach"
          }
        ]
      }
    ]
  ...
  "EN": {
    "id": "affoltern_en",
    "h1": "Mobile Bike Mechanic Affoltern, Oerlikon & Seebach – Bicycle Repair Kreis 11 (on-site)",
    "intro": "Flat tyre in Affoltern, Oerlikon & Seebach? VELOV is your mobile bike workshop in Kreis 11, usually on-site within 55 minutes. Service area includes: Bahnhof Oerlikon, Marktplatz Oerlikon, Hallenstadion, Messe Zürich, Sternen Oerlikon, MFO-Park.",
    "sections": [
      {
        "h2": "Affoltern, Oerlikon & Seebach – we know the area",
        "body": "Kreis 11 – Oerlikon is almost a city of its own with Bahnhof Oerlikon, Hallenstadion, Messe Zürich. Affoltern and Seebach are growing fast with many new estates and bike rooms. We are here several times a week for services and flat-tyre calls. MFO-Park and Marktplatz Oerlikon are classic meeting points."
      },
      {
        "h2": "Hotspots in the area",
        "body": "Near Bahnhof Oerlikon, Hallenstadion and MFO-Park we regularly run large B2B service days – Oerlikon's high-rise residences are ideal for our model. Bahnhof Oerlikon · Marktplatz Oerlikon · Hallenstadion · Messe Zürich · Sternen Oerlikon · MFO-Park · Bahnhof Affoltern · Bahnhof Seebach"
      }
    ],
    "faqs": [
      {
        "q": "How fast are you in Affoltern, Oerlikon & Seebach?",
        "a": "Usually 40–60 minutes after WhatsApp booking – Affoltern, Oerlikon & Seebach is on our daily route."
      },
      {
        "q": "Which postcodes do you cover in Kreis 11?",
        "a": "We serve all addresses in Kreis 11 (8046, 8050, 8052) with no surcharge inside the city."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes – B2B service days in Affoltern, Oerlikon & Seebach bookable from CHF 49 travel fee. See velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 for flat-tyre emergencies in Affoltern, Oerlikon & Seebach (Kreis 11) · info@velov.ch"
  },
  "FR": {
    "id": "affoltern_fr",
    "h1": "Mécanicien vélo mobile Affoltern, Oerlikon & Seebach – Réparation vélo Kreis 11 (sur place)",
    "intro": "Crevaison à Affoltern, Oerlikon & Seebach ? VELOV est votre atelier vélo mobile dans le Kreis 11, généralement sur place en 55 minutes. Zone de service : Bahnhof Oerlikon, Marktplatz Oerlikon, Hallenstadion, Messe Zürich, Sternen Oerlikon, MFO-Park.",
    "sections": [
      {
        "h2": "Affoltern, Oerlikon & Seebach – nous connaissons le quartier",
        "body": "Kreis 11 – Oerlikon, presque une ville à part : gare Oerlikon, Hallenstadion, Messe Zürich. Affoltern et Seebach en pleine croissance, nouveaux ensembles avec locaux à vélos. Plusieurs fois par semaine sur place. MFO-Park et Marktplatz Oerlikon, points de rendez-vous classiques."
      },
      {
        "h2": "Points clés du quartier",
        "body": "Près de la gare Oerlikon, du Hallenstadion et du MFO-Park – grandes journées B2B régulières. Bahnhof Oerlikon · Marktplatz Oerlikon · Hallenstadion · Messe Zürich · Sternen Oerlikon · MFO-Park · Bahnhof Affoltern · Bahnhof Seebach"
      }
    ],
    "faqs": [
      {
        "q": "À quelle vitesse arrivez-vous à Affoltern, Oerlikon & Seebach ?",
        "a": "Habituellement 40–60 minutes après la réservation WhatsApp – Affoltern, Oerlikon & Seebach est sur notre tournée quotidienne."
      },
      {
        "q": "Quels codes postaux couvrez-vous dans le Kreis 11 ?",
        "a": "Toutes les adresses du Kreis 11 (8046, 8050, 8052), sans supplément en ville."
      },
      {
      ...
      },
      {
        ...
        "a": "Oui – journées B2B à Affoltern, Oerlikon & Seebach dès CHF 49 de déplacement. Voir velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 pour urgences crevaison à Affoltern, Oerlikon & Seebach (Kreis 11) · info@velov.ch"
  },
  "IT": {
    "id": "affoltern_it",
    "h1": "Meccanico bici mobile Affoltern, Oerlikon & Seebach – Riparazione bici Kreis 11 (sul posto)",
    "intro": "Foratura a Affoltern, Oerlikon & Seebach? VELOV è la tua officina mobile nel Kreis 11, di solito sul posto in 55 minuti. Zona di servizio: Bahnhof Oerlikon, Marktplatz Oerlikon, Hallenstadion, Messe Zürich, Sternen Oerlikon, MFO-Park.",
    "sections": [
      {
        "h2": "Affoltern, Oerlikon & Seebach – conosciamo il quartiere",
        "body": "Kreis 11 – Oerlikon è quasi una città a sé: stazione, Hallenstadion, Messe Zürich. Affoltern e Seebach in forte crescita, nuovi complessi con sale bici. Diverse volte a settimana sul posto. MFO-Park e Marktplatz Oerlikon, classici punti d'incontro."
      },
      {
        "h2": "Punti chiave del quartiere",
        "body": "Vicino alla stazione Oerlikon, Hallenstadion e MFO-Park – grandi giornate B2B regolari. Bahnhof Oerlikon · Marktplatz Oerlikon · Hallenstadion · Messe Zürich · Sternen Oerlikon · MFO-Park · Bahnhof Affoltern · Bahnhof Seebach"
      }
    ],
    "faqs": [
      {
        "q": "Quanto siete veloci a Affoltern, Oerlikon & Seebach?",
        "a": "Di solito 40–60 minuti dalla prenotazione WhatsApp – Affoltern, Oerlikon & Seebach è nel nostro giro quotidiano."
      },
      {
        "q": "Quali CAP coprite nel Kreis 11?",
        "a": "Tutti gli indirizzi del Kreis 11 (8046, 8050, 8052), senza supplemento in città."
      },
      {
      ...
      },
      {
        ...
        "a": "Sì – giornate B2B a Affoltern, Oerlikon & Seebach da CHF 49 di trasferta. Vedi velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 per emergenze foratura a Affoltern, Oerlikon & Seebach (Kreis 11) · info@velov.ch"
  },
  "ES": {
    "id": "affoltern_es",
    "h1": "Mecánico de bici móvil Affoltern, Oerlikon & Seebach – Reparación de bicicleta Kreis 11 (in situ)",
    "intro": "¿Pinchazo en Affoltern, Oerlikon & Seebach? VELOV es tu taller móvil de bicis en el Kreis 11, normalmente en el lugar en 55 minutos. Zona de servicio: Bahnhof Oerlikon, Marktplatz Oerlikon, Hallenstadion, Messe Zürich, Sternen Oerlikon, MFO-Park.",
    "sections": [
      {
        "h2": "Affoltern, Oerlikon & Seebach – conocemos el barrio",
        "body": "Kreis 11 – Oerlikon es casi una ciudad propia: estación, Hallenstadion, Messe Zürich. Affoltern y Seebach crecen rápido, nuevos bloques con salas de bicis. Varias veces por semana en la zona. MFO-Park y Marktplatz Oerlikon, puntos clásicos de encuentro."
      },
      {
        "h2": "Puntos clave del barrio",
        "body": "Cerca de Bahnhof Oerlikon, Hallenstadion y MFO-Park – grandes jornadas B2B regulares. Bahnhof Oerlikon · Marktplatz Oerlikon · Hallenstadion · Messe Zürich · Sternen Oerlikon · MFO-Park · Bahnhof Affoltern · Bahnhof Seebach"
      }
    ],
    "faqs": [
      {
        "q": "¿Cuán rápido llegáis a Affoltern, Oerlikon & Seebach?",
        "a": "Normalmente 40–60 minutos tras la reserva por WhatsApp – Affoltern, Oerlikon & Seebach está en nuestra ruta diaria."
      },
      {
        "q": "¿Qué códigos postales cubrís en el Kreis 11?",
        "a": "Todas las direcciones del Kreis 11 (8046, 8050, 8052), sin recargo en la ciudad."
      },
      {
      ...
      },
      {
        ...
        "a": "Sí – jornadas B2B en Affoltern, Oerlikon & Seebach desde CHF 49 de desplazamiento. Ver velov.ch/b2b."
      }
    ],
    "contact": "WhatsApp +41 76 235 21 26 para urgencias de pinchazo en Affoltern, Oerlikon & Seebach (Kreis 11) · info@velov.ch"
  }
};

const VELOV_SEO_AFFOLTERN_I18N = {
  "DE": {
    "heroH1": "Mobiler Velomechaniker Affoltern, Oerlikon & Seebach – Velo-Reparatur Kreis 11 (vor Ort)",
    "heroTagline": "Mobile Fahrrad- & E-Bike Reparatur in Affoltern, Oerlikon & Seebach, Kreis 11 (8046, 8050, 8052). Wir kommen per Velo & Cargo-Bike zu dir nach Hause oder ins Büro. Anfahrt CHF 49.",
    "heroSub": "📍 Kreis 11 · Ø 55 Min Reaktionszeit · Same-day 24h",
    "crumbHome": "Home",
    "crumbLocations": "Alle Standorte",
    "kreisName": "Affoltern, Oerlikon & Seebach",
    ...
    "boxDur": "Dauer",
    "boxEta": "Reaktion",
    "cta": "📱 Jetzt in Affoltern, Oerlikon & Seebach buchen →",
    "sectionServices": "Services in Affoltern, Oerlikon & Seebach",
    "sectionWhy": "Warum VELOV in Affoltern, Oerlikon & Seebach?",
    "sectionCommon": "Häufige Probleme in Affoltern, Oerlikon & Seebach — VELOV Lösung",
    "sectionStory": "Affoltern, Oerlikon & Seebach – wir kennen das Quartier",
    "finalH2": "Dein Fahrrad kaputt in Affoltern, Oerlikon & Seebach?",
    "finalP": "Same-day verfügbar. Schreib uns — Antwort in wenigen Minuten.",
    "finalBtn": "→ WhatsApp buchen (Affoltern, Oerlikon & Seebach)",
    "finalCallPrefix": "oder ruf an:",
    "waMsgPrefix": "Hi VELOV, ich bin in Affoltern, Oerlikon & Seebach und brauche eine Velo-Reparatur.",
    "waMsgSym": "Symptome:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Blitzschnell",
        "text": "Oft in unter 1 Stunde in Affoltern, Oerlikon & Seebach. Same-day Buchung."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Platten auf dem Weg zur Arbeit?</strong> → Ruf VELOV an, wir reparieren in Affoltern, Oerlikon & Seebach in 30 Min.",
    ...
    "story": "Kreis 11 – Oerlikon ist heute fast eine eigene Stadt mit Bahnhof Oerlikon, Hallenstadion, Messe Zürich. Affoltern und Seebach wachsen schnell, viele neue Wohnsiedlungen mit Veloräumen. Wir sind hier oft mehrmals pro Woche für Wartungen und Plattfuss-Einsätze. MFO-Park und Marktplatz Oerlikon sind klassische Treffpunkte.",
    "storyShort": "In der Nähe vom Bahnhof Oerlikon, am Hallenstadion und am MFO-Park machen wir regelmässig grosse B2B-Aktionstage – Oerlikon ist mit seinen Hochhaus-Wohnungen ideal für unser Modell."
  },
  "EN": {
    "heroH1": "Mobile Bike Mechanic Affoltern, Oerlikon & Seebach – Bicycle Repair Kreis 11 (on-site)",
    "heroTagline": "Mobile bicycle & e-bike repair in Affoltern, Oerlikon & Seebach, Kreis 11 (8046, 8050, 8052). We come by bike & cargo bike to your home or office. Travel fee CHF 49.",
    "heroSub": "📍 Kreis 11 · Ø 55 min reaction time · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Duration",
    "boxEta": "Arrival",
    "cta": "📱 Book Affoltern, Oerlikon & Seebach now →",
    "sectionServices": "Services in Affoltern, Oerlikon & Seebach",
    "sectionWhy": "Why VELOV in Affoltern, Oerlikon & Seebach?",
    "sectionCommon": "Common problems in Affoltern, Oerlikon & Seebach — VELOV solution",
    "sectionStory": "Affoltern, Oerlikon & Seebach – we know the area",
    "finalH2": "Bike broken in Affoltern, Oerlikon & Seebach?",
    "finalP": "Same-day available. Message us — reply in minutes.",
    "finalBtn": "→ Book on WhatsApp (Affoltern, Oerlikon & Seebach)",
    "finalCallPrefix": "or call:",
    "waMsgPrefix": "Hi VELOV, I am in Affoltern, Oerlikon & Seebach and need a bike repair.",
    "waMsgSym": "Symptoms:",
    "waMsgUrg": "Urgency:",
    ...
    "features": [
      {
        ...
        "text": "Often under 1 hour in Affoltern, Oerlikon & Seebach. Same-day booking."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Flat on the way to work?</strong> → Call VELOV, we repair in Affoltern, Oerlikon & Seebach within 30 min.",
    ...
    "story": "Kreis 11 – Oerlikon is almost a city of its own with Bahnhof Oerlikon, Hallenstadion, Messe Zürich. Affoltern and Seebach are growing fast with many new estates and bike rooms. We are here several times a week for services and flat-tyre calls. MFO-Park and Marktplatz Oerlikon are classic meeting points.",
    "storyShort": "Near Bahnhof Oerlikon, Hallenstadion and MFO-Park we regularly run large B2B service days – Oerlikon's high-rise residences are ideal for our model."
  },
  "FR": {
    "heroH1": "Mécanicien vélo mobile Affoltern, Oerlikon & Seebach – Réparation vélo Kreis 11 (sur place)",
    "heroTagline": "Réparation mobile de vélos & vélos électriques à Affoltern, Oerlikon & Seebach, Kreis 11 (8046, 8050, 8052). Nous venons à vélo & cargo bike chez vous ou au bureau. Frais de déplacement CHF 49.",
    "heroSub": "📍 Kreis 11 · ~55 min de réaction · Same-day 24h",
    "crumbHome": "Accueil",
    ...
    "boxDur": "Durée",
    "boxEta": "Arrivée",
    "cta": "📱 Réserver à Affoltern, Oerlikon & Seebach →",
    "sectionServices": "Services à Affoltern, Oerlikon & Seebach",
    "sectionWhy": "Pourquoi VELOV à Affoltern, Oerlikon & Seebach ?",
    "sectionCommon": "Problèmes fréquents à Affoltern, Oerlikon & Seebach — solution VELOV",
    "sectionStory": "Affoltern, Oerlikon & Seebach – nous connaissons le quartier",
    "finalH2": "Vélo en panne à Affoltern, Oerlikon & Seebach ?",
    "finalP": "Disponible le jour même. Écrivez-nous — réponse en quelques minutes.",
    "finalBtn": "→ Réserver sur WhatsApp (Affoltern, Oerlikon & Seebach)",
    "finalCallPrefix": "ou appelez :",
    "waMsgPrefix": "Bonjour VELOV, je suis à Affoltern, Oerlikon & Seebach et j'ai besoin d'une réparation vélo.",
    "waMsgSym": "Symptômes :",
    "waMsgUrg": "Urgence :",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra-rapide",
        "text": "Souvent moins d'1 heure à Affoltern, Oerlikon & Seebach. Réservation le jour même."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Crevaison sur le chemin du travail ?</strong> → Appelez VELOV, réparation à Affoltern, Oerlikon & Seebach en 30 min.",
    ...
    "story": "Kreis 11 – Oerlikon, presque une ville à part : gare Oerlikon, Hallenstadion, Messe Zürich. Affoltern et Seebach en pleine croissance, nouveaux ensembles avec locaux à vélos. Plusieurs fois par semaine sur place. MFO-Park et Marktplatz Oerlikon, points de rendez-vous classiques.",
    "storyShort": "Près de la gare Oerlikon, du Hallenstadion et du MFO-Park – grandes journées B2B régulières."
  },
  "IT": {
    "heroH1": "Meccanico bici mobile Affoltern, Oerlikon & Seebach – Riparazione bici Kreis 11 (sul posto)",
    "heroTagline": "Riparazione mobile bici ed e-bike a Affoltern, Oerlikon & Seebach, Kreis 11 (8046, 8050, 8052). Veniamo in bici & cargo bike a casa o ufficio. Spostamento CHF 49.",
    "heroSub": "📍 Kreis 11 · ~55 min di reazione · Same-day 24h",
    "crumbHome": "Home",
    ...
    "boxDur": "Durata",
    "boxEta": "Arrivo",
    "cta": "📱 Prenota a Affoltern, Oerlikon & Seebach →",
    "sectionServices": "Servizi a Affoltern, Oerlikon & Seebach",
    "sectionWhy": "Perché VELOV a Affoltern, Oerlikon & Seebach?",
    "sectionCommon": "Problemi frequenti a Affoltern, Oerlikon & Seebach — soluzione VELOV",
    "sectionStory": "Affoltern, Oerlikon & Seebach – conosciamo il quartiere",
    "finalH2": "Bici rotta a Affoltern, Oerlikon & Seebach?",
    "finalP": "Disponibile in giornata. Scrivici — risposta in pochi minuti.",
    "finalBtn": "→ Prenota su WhatsApp (Affoltern, Oerlikon & Seebach)",
    "finalCallPrefix": "oppure chiama:",
    "waMsgPrefix": "Ciao VELOV, sono a Affoltern, Oerlikon & Seebach e ho bisogno di una riparazione.",
    "waMsgSym": "Sintomi:",
    "waMsgUrg": "Urgenza:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Velocissimo",
        "text": "Spesso meno di 1 ora a Affoltern, Oerlikon & Seebach. Prenotazione in giornata."
      },
      {
        "emoji": "📍",
    ...
    "commonProblems": [
      "<strong>Foratura andando al lavoro?</strong> → Chiama VELOV, riparazione a Affoltern, Oerlikon & Seebach in 30 min.",
    ...
    "story": "Kreis 11 – Oerlikon è quasi una città a sé: stazione, Hallenstadion, Messe Zürich. Affoltern e Seebach in forte crescita, nuovi complessi con sale bici. Diverse volte a settimana sul posto. MFO-Park e Marktplatz Oerlikon, classici punti d'incontro.",
    "storyShort": "Vicino alla stazione Oerlikon, Hallenstadion e MFO-Park – grandi giornate B2B regolari."
  },
  "ES": {
    "heroH1": "Mecánico de bici móvil Affoltern, Oerlikon & Seebach – Reparación de bicicleta Kreis 11 (in situ)",
    "heroTagline": "Reparación móvil de bicis y e-bikes en Affoltern, Oerlikon & Seebach, Kreis 11 (8046, 8050, 8052). Vamos en bici y cargo bike a tu casa u oficina. Desplazamiento CHF 49.",
    "heroSub": "📍 Kreis 11 · ~55 min de reacción · Same-day 24h",
    "crumbHome": "Inicio",
    ...
    "boxDur": "Duración",
    "boxEta": "Llegada",
    "cta": "📱 Reservar en Affoltern, Oerlikon & Seebach →",
    "sectionServices": "Servicios en Affoltern, Oerlikon & Seebach",
    "sectionWhy": "¿Por qué VELOV en Affoltern, Oerlikon & Seebach?",
    "sectionCommon": "Problemas frecuentes en Affoltern, Oerlikon & Seebach — solución VELOV",
    "sectionStory": "Affoltern, Oerlikon & Seebach – conocemos el barrio",
    "finalH2": "¿Bici rota en Affoltern, Oerlikon & Seebach?",
    "finalP": "Disponible el mismo día. Escríbenos — respuesta en pocos minutos.",
    "finalBtn": "→ Reservar por WhatsApp (Affoltern, Oerlikon & Seebach)",
    "finalCallPrefix": "o llama:",
    "waMsgPrefix": "Hola VELOV, estoy en Affoltern, Oerlikon & Seebach y necesito una reparación.",
    "waMsgSym": "Síntomas:",
    "waMsgUrg": "Urgencia:",
    ...
    "features": [
      {
        "emoji": "⚡",
        "title": "Ultra rápido",
        "text": "Frecuente menos de 1 hora en Affoltern, Oerlikon & Seebach. Reserva el mismo día."
      },
      {
        "emoji": "📍",
        "title": "In situ",
    ...
    "commonProblems": [
      "<strong>¿Pinchazo de camino al trabajo?</strong> → Llama a VELOV, reparación en Affoltern, Oerlikon & Seebach en 30 min.",
    ...
    "story": "Kreis 11 – Oerlikon es casi una ciudad propia: estación, Hallenstadion, Messe Zürich. Affoltern y Seebach crecen rápido, nuevos bloques con salas de bicis. Varias veces por semana en la zona. MFO-Park y Marktplatz Oerlikon, puntos clásicos de encuentro.",
    "storyShort": "Cerca de Bahnhof Oerlikon, Hallenstadion y MFO-Park – grandes jornadas B2B regulares."
  }
};

const VELOV_SEO_AFFOLTERN_KREIS = {
  "id": "affoltern",
  "slug": "affoltern-oerlikon-seebach",
  "kreis": 11,
  "kreisLabel": "Kreis 11",
  "plz": [
    "8046",
...
class VelovAffoltern extends HTMLElement {
  constructor() {
    super();
  ...
  static get CONFIG() {
    return {
      zone: 'Affoltern, Oerlikon & Seebach',
      kreisId: 'affoltern',
      kreisLabel: 'Kreis 11',
      phone: '+41762352126',
      ...
      url: 'https://velov.ch/affoltern-oerlikon-seebach',
      baseEta: 55,
      neighbours: [{ slug: 'wipkingen-hoengg', name: 'Wipkingen & Höngg' }, { slug: 'unterstrass-oberstrass', name: 'Unterstrass & Oberstrass' }, { slug: 'schwamendingen', name: 'Schwamendingen' }]
    };
  }

  connectedCallback() {
    this.lang = this.detectLang();
    const seoCfg = VELOV_SEO_AFFOLTERN_BY_LANG[this.lang] || VELOV_SEO_AFFOLTERN_BY_LANG.DE;
  ...
  injectStyles() {
    const styleId = 'velov-affoltern-styles';
    if (document.getElementById(styleId)) return;
    const style = document.createElement('style');
    style.id = styleId;
    style.textContent = `
      velov-affoltern { display: block; width: 100%; font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif; color: #2D2B3D; box-sizing: border-box; }
      velov-affoltern *, velov-affoltern *::before, velov-affoltern *::after { box-sizing: border-box; }
  ...
  render() {
    const C = VelovAffoltern.CONFIG;
    const T = VELOV_SEO_AFFOLTERN_I18N[this.lang] || VELOV_SEO_AFFOLTERN_I18N.DE;
    ...
    const lmHtml = VELOV_SEO_AFFOLTERN_KREIS.landmarks.slice(0, 8).map(function(lm){
...
if (!customElements.get('velov-affoltern')) {
  customElements.define('velov-affoltern', VelovAffoltern);
}
